...
**Currency and Baseline** establishes the obol as universal standard, defines subsistence through the Kess benchmark, and provides the wage/price framework against which all other figures are measured.
...
**Comparative Analysis** examines how each system differs from and resembles capitalism, with historical parallels for each regional economy.

**Consistency Requirements** lists established economic facts that must not be contradicted.
...
* Establishing a character's income level or economic class  
* Writing scenes involving purchases, wages, or financial transactions  
* Determining what goods or services a character can afford  
* Understanding economic tensions between regions or classes  
* Writing about trade relationships between territories  
* Establishing economic motivations for character behavior

**Search for other documents when:**

* You need detailed information on specific Aureate families (search Aureate System or household dossiers)  
* You need guild structure details (search ya-Don Guilds or ya-Sattra Guilds)  
* You need political context for economic arrangements (search Imperial Government or Ganat)  
* You need caste-specific economic roles (search caste documents)  
* You need location-specific details beyond economics (search location documents)

---

### **RAG Retrieval Notes**

**"Obol" or "wages" retrieves baseline economics.** The obol is the universal currency standard; all regional currencies convert to obol-equivalents for comparison.
...
**"Three-tier market" or "guild goods" retrieves consumer pricing.** The distinction between guild production, unlicensed goods, and Ganati imports determines what characters can afford.

---

## **Currency and Baseline Economics**
...
### **The Kess Benchmark: Defining Subsistence**

Subsistence economics are calibrated against Kess, a courier working the Rotten Quarter of ya-Sattra. Her income and expenses establish the minimum required for survival in the Imperial capital.
...
All figures in obols unless otherwise specified.

**Subsistence Tiers:**

| Category | Monthly Income | Living Conditions |
| ----- | ----- | ----- |
| Destitute | 40-70 | Sleeps rough, irregular meals, owns nothing |
| Subsistence | 90-120 | Bunkhouse, eats most days, no margin |
| Working poor | 140-200 | Shared housing, regular meals, small savings possible |
| Lower middle | 250-350 | Private room, occasional guild goods, slow accumulation |
| Middle class | 400-600 | Comfortable housing, guild goods, might own lector |
| Upper middle | 800-1,200 | Servants, regular luxuries, meaningful savings |
| Wealthy | 2,000+ | Multiple properties, staff, discretionary abundance |

**Basic Necessities:**

| Item | Price | Notes |
| ----- | ----- | ----- |
| Beer (cup) | 1/16 obol | Common drink |
| Coca tea | 1/8 obol | Standing teahouse |
| Basic meal (street food) | 1/8-1/4 obol | Noodles, skewers, flatbread |
| Decent meal (seated) | 1/2-1 obol | Tavern fare with table |
| Bunkhouse (weekly) | 5 obols | Shared facilities, minimal privacy |
| Cheap room (monthly) | 35-50 obols | Shared building, basic amenities |
| Decent housing (monthly) | 80-120 obols | Private room, respectable neighborhood |
| Good housing (monthly) | 150-250 obols | Multiple rooms, comfortable district |

**Clothing:**

| Item | Guild Price | Unlicensed Price | Notes |
| ----- | ----- | ----- | ----- |
...
## **The Three-Tier Imperial Market**

Consumer goods in the Empire flow through three distinct channels, each with different pricing logic.
...
### **Consumer Experience by Class**

**Working poor (140-200 obols/month):** Buys unlicensed or Ganati goods for daily wear. Might own one guild-quality outfit for religious observance or special occasions. Will never own a lector; lives in a world of sophisticated technology entirely inaccessible to them.

**Lower middle (250-350 obols/month):** Buys guild goods when replacing worn items. Accumulates slowly toward major purchases. Might save for years toward a household lector.

**Middle class (400-600 obols/month):** Buys guild goods as standard. May own family lector inherited or purchased over years. Lives comfortably but without abundance.

**Wealthy (2,000+ obols/month):** Price is not a consideration for ordinary goods. Economic constraints exist at the level of property, business investment, and political influence rather than daily purchases.

---

## **Regional Economic Systems**

### **The Imperial Core: Rent Extraction**

The Imperial economy generates wealth through extraction rather than production. Aureate families don't make goods; they authenticate. The es-Tsay patent doesn't produce lectors; it makes lectors function. The distinction is fundamental: capitalist profit comes from creating value; Aureate rent comes from taxing value others create.

Guild monopolies operate similarly. The Clothiers' Guild doesn't compete for customers through price or quality; their charter grants exclusive rights regardless of performance. A merchant cannot undercut guild prices by producing more efficiently; the charter forbids competition.

This creates an economy of inherited position rather than market competition. The guilds were chartered millennia ago by authority that no longer functions to revoke them. The patents self-enforce through quantum encryption. No entrepreneur can disrupt these arrangements through innovation.

**Wages in ya-Sattra:**

| Occupation | Monthly Income |
| ----- | ----- |
| Casual laborer | 100-140 obols |
| Dock worker | 160-200 obols |
| Skilled guild artisan | 280-380 obols |
| Bureau clerk (junior) | 350-450 obols |
| Bureau clerk (senior) | 500-700 obols |
| Aureate pension (vestigial) | 80-120 obols |

**Historical parallel:** Late medieval guild economy, but more calcified. Medieval guilds could be dissolved by royal authority or undermined by rural production; Imperial guilds face no such pressures.
...
The es-Etaie capitation arrangement exemplifies non-capitalist logic: one family pays religious tax for 40,000 workers, funding their freedom to worship without extracting corresponding labor.

**Wages in ya-Don:**

| Position | Monthly Income |
| ----- | ----- |
| Apprentice | 80-100 obols (plus housing, meals) |
| Journeyman (inner-ring) | 280-350 obols |
| Senior worker | 380-480 obols |
| Council member | 550-700 obols |
| Forge-Master | 700-850 obols |
...
**Wages in Taho (1 dinar \= 10 obols):**

| Occupation | Monthly Income |
| ----- | ----- |
| Dock worker | 18-22 dinars (180-220 obols) |
| Warehouse worker | 16-20 dinars (160-200 obols) |
| Workshop laborer | 18-24 dinars (180-240 obols) |
| Factory foreman | 32-45 dinars (320-450 obols) |
| Merchant factor | 60+ dinars (600+ obols) |
| Major merchant (personal draw) | 400-600 dinars (4,000-6,000 obols) |
...
External trade operates normally. Ezh Tan banking follows recognizable practices. The strangeness is invisible, operating through mechanisms that don't appear in ledgers.

**Wages in ya-Tsatsa:**

| Occupation | Monthly Income |
| ----- | ----- |
| Software corporation worker | 350-450 obols |
| Skilled technical specialist | 500-700 obols |
| Ezh Tan family member | 8,000-12,000 obols (spending authority) |
...
| ----- | ----- |
| Ordinary house member | 50-80 obols in goods |
| Skilled worker | 100-150 obols in goods |
...
### **The Thousand Kingdoms: Gambling Redistribution**

Wealth distributes through rigged games where everyone knows the rigging. A successful warband leader "loses" to subordinates who need resources. A widow with seven children develops miraculous luck. Distribution follows need, disguised as fortune.

This violates market logic completely. In capitalism, need requires offering something in exchange. In the Thousand Kingdoms, need produces favorable dice. The mechanism is transparent to participants but maintains the fiction that fortune rather than charity determined outcomes. Direct aid would be "theft of sacred experience"; gambling losses are fortune's judgment.

The salmon economy is seasonal and non-accumulable. For six weeks everyone feasts; the rest of the year survives on preserved fish. Canal positions are held by force and inheritance, not purchased in markets.

**Income equivalents in the Thousand Kingdoms:**

| Position | Annual Equivalent |
| ----- | ----- |
| Village headwoman | \~200 obols consumed (controls distribution) |
| Warband rider | \~100 obols in goods/loot |
| Kma-Dhol engineer | \~600-800 obols |
| Salvage Guild factor | 6,000-8,400 obols (hardship pay) |

**Distinctive feature:** Conversion to obols is misleading. A rider earning "100 obols/year equivalent" may be better fed and equipped than a ya-Sattran worker at 150/month because the warband provides what he needs while the ya-Sattran must purchase everything.

**Historical parallel:** Pacific Northwest potlatch economies where wealth demonstrated through giving, combined with Central Asian pastoral economics of raid and patronage.

---

## **Character Economics by Income Level**
...
### **Working Poor (140-200 obols/month)**

**Profile:** Dock worker or factory laborer. Shared housing at 40-55 obols. Food at 70-100 obols. Small margin of 20-40 obols monthly for clothing, emergencies, slow saving.

**Spending pattern:** Clothing purchases from unlicensed vendors, occasional guild goods when something must last. Occasional beer after work. Saving toward nothing specific because major purchases remain difficult.

**Anxieties:** Injury that prevents work. Children needing education beyond parish school. The gap between current position and visible comfort above.

### **Lower Middle (250-350 obols/month)**
...
### **Middle Class (400-600 obols/month)**

**Profile:** Senior artisan or Bureau clerk. Comfortable housing at 100-150 obols. Regular guild goods. May own family lector.

**Spending pattern:** Guild clothing as needed. Regular entertainment. Education for children. Saving toward property or inheritance for family.

**Anxieties:** Maintaining position across generations. Bureau politics or guild standing. Children's marriages and career prospects.

### **Wealthy Aureate (2,000+ obols/month)**

**Profile:** Minor patent holder or senior household member. Housing not a cost (family property). Staff, multiple properties, abundant discretionary spending.

**Spending pattern:** Price is not a daily consideration. Economic constraints exist at levels of business investment, political influence, and family obligation rather than consumer purchases.

**Anxieties:** Patent disputes. Family politics. Bureau intervention. Status relative to wealthier Aureates. The gap between position and truly powerful families.

### **Major Aureate (processing millions monthly)**

**Profile:** The es-Tsay processing 4 million obols daily. The es-Norren receiving fractions of every classified communication. Wealth beyond individual consumption.

**Spending pattern:** Personal expenses are trivial relative to resources. Economic activity focuses on maintaining patent position, political maneuvering, and family legacy across generations.

**Anxieties:** Charter politics threatening patent structure. Satara intervention. Competition from other major families. The burden of maintaining systems no one fully understands.
...
**No creative destruction.** Existing arrangements persist indefinitely. Guilds have held charters for millennia. Patents self-enforce through technology. No entrepreneur can disrupt through innovation.
...
### **What They Share with Capitalism**
...
| Region | Primary Parallel | Secondary Influences |
| ----- | ----- | ----- |
| Imperial Core | Late medieval guild economy | Byzantine regulatory state |
...
The following economic facts are established and must not be contradicted:

**Currency:**

* The obol is the Imperial standard  
* The Ganati dinar equals 10 obols  
* Many maintains exchange rates

**Baseline:**

* Subsistence in ya-Sattra requires 90-110 obols monthly  
* Bunkhouse rent runs \~20-22 obols monthly (5/week)  
* Daily food costs \~1.5-2 obols minimum

**Patent economics:**

* The es-Tsay lector patent processes \~4 million obols daily  
* Household lectors cost 400-600 obols  
* Patent rents concentrate in complex technology, not basic goods

**Guild pricing:**

* Guild shirt: 3-4 obols  
* Unlicensed shirt: 1-1.5 obols  
* Ganati import shirt: 2 obols (better quality than unlicensed)  
* Complete guild outfit: 12-18 obols
...
**Treating all economies as variations of capitalism.** The surface forms (currency, prices, wages) appear everywhere, but underlying logics differ fundamentally. A ya-Don worker's "wage" is closer to monastic allocation than labor market pricing.

**Ignoring regional variation in prices.** Food costs more in Taho (altitude imports) than ya-Sattra. Housing costs more in the Inner City than the Middens. The same nominal income produces different living standards by location.
...
**Underestimating Aureate wealth concentration.** The gap between major patent-holders and everyone else exceeds any wealth inequality in historical capitalism. Families processing millions daily exist alongside workers earning hundreds monthly.

---

# **Economic Institutions of the Post-Interdict World**
...
## **Ya-Sattra: The Imperial Capital**
...
* Transaction fees: 0.5-2% of witnessed contracts, scaling with complexity  
* Deposit fees: 0.1% monthly on stored funds  
* Arbitration fees: 5-50 obols per proceeding depending on stakes  
* Interest on loans: typically 1.5% monthly, lower than any competitor because Many has no biological need for profit  
* Real estate holdings: Many owns property throughout ya-Sattra accumulated over millennia

**Annual revenue:** Impossible to calculate precisely, but the countinghouse processes perhaps 40% of ya-Sattra's formal commercial transactions. Estimated 2-4 million obols annually in direct fees, plus investment returns on accumulated reserves exceeding 100 million obols.
...
* Headquarters: The great dome in the Iron Yards (ya-Sattra)  
* Major branch operations: ya-Don (Furnace-adjacent salvage), the Threshing Coast, and every significant port  
* Frontier purchasing offices: Ogon and other Thousand Kingdoms contact points  
* Certification authority: Every piece of salvage leaving any Imperial port requires Guild stamps  
* 147 master memberships at headquarters, plus licensed factors and certified assessors throughout the Empire  
* Thousands of contractors operating under master licenses

**Cash flow in:**

* Auction and transaction fees (18-30% across all Imperial salvage operations): 12-20 million obols/year  
* Certification fees (mandatory for all salvage exports Empire-wide): 3-6 million obols/year  
* Training programs across all branches: 1-2 million obols/year  
* Storage fees in Guild warehouses throughout the Empire: 1-2 million obols/year  
...
* Bureau relationships Empire-wide: \~500,000-800,000 obols/year in "administrative facilitation fees" to Rod and Lens inspectors across all territories  
* Legal defense: \~200,000 obols/year maintaining the perpetual lawsuit with Rod Aureates  
* Headquarters staff: \~200 administrative clerks at 300-400 obols/month \= \~800,000 obols/year  
* Branch operations: Perhaps 500 staff across all Empire locations \= \~2-3 million obols/year  
* Infrastructure: dome maintenance, warehouses throughout the Empire, security \= \~1-2 million obols/year  
* Frontier purchasing operations: Maintaining factors at Ogon and other contact points \= \~500,000 obols/year  
...
* Headquarters: The Cathedral of the Plea (ya-Sattra), containing Technical Caste archives in the jargon  
* Major facilities: The Monastery of the Silent Song (kalbat care), the ya-Sattra Guildhall (near the Iron Yards)  
* Chapter houses: Every major Imperial city has a Companions Guild chapter (ya-Don chapter has \~200 members)  
* Hospice system: Dozens of hospices throughout the Empire, from the politically contentious Dockside Hospice in ya-Sattra to provincial facilities attached to Penitent churches  
* Frontier posts: Single Companions managing small Mutterer groups in settlements that would otherwise have no technical services  
* Total personnel: Perhaps 2,000-3,000 Companions Empire-wide, plus support staff
...
* Training and certification fees: Companion training takes years; fees are substantial. Perhaps 500,000 obols/year.  
* Hospice patient fees: Sliding scale based on ability to pay; wealthy patients subsidize poor ones. Perhaps 1-2 million obols/year.

**Annual revenue:** Perhaps 10-15 million obols, making the Guild one of the most economically significant institutions in the Empire despite their humble presentation. Their monopoly over essential services gives them leverage that their apparent poverty obscures.

**Cash flow out:**

* Companion salaries Empire-wide: 2,000-3,000 Companions at varying rates (initiates earn little; Sri Companions earn well). Perhaps 3-5 million obols/year.  
...
The Guild's impossible position shapes all decisions: they are absolutely essential, politically powerless, and pulled between mutually antagonistic clients (Rod, Creche, Church, private clients) who each partially own them. They survive not through strength but through being too useful to destroy and too compromised to threaten anyone.
...
* Sales: A medium guild shop might sell 600-900 obols of goods monthly  
* Guild membership dues from journeymen and apprentices: 5-15 obols/month per worker  
* Subcontracting fees from unlicensed producers seeking guild stamps: variable

**Annual revenue:** A typical guild master with twelve employees might gross 8,000-12,000 obols annually.

**Cash flow out:**

* Materials: 30-40% of revenue (thread, dye, cloth from licensed suppliers)  
* Labor: journeymen wages 250-350 obols/month, apprentice stipends 80-100 obols/month  
* Guild dues: 3-5% of revenue to the guild central fund  
...
### **Bureau of the Coin Revenue Station (Medina District)**

**What it does:** Tax collection, currency authentication, financial regulation for a defined territory. One of dozens of stations throughout ya-Sattra.

**Cash flow in:**

* Transaction taxes: 0.5-1% of commercial transactions exceeding 10 obols  
* Currency authentication fees: 0.1 obol per transaction using Bureau-certified scales  
* Licensing fees: businesses operating in territory pay 50-200 obols annually  
* Fine collection: variable, perhaps 5,000-10,000 obols monthly from violations

**Annual throughput:** A busy Medina station might process 50,000-80,000 obols monthly in taxes and fees.

**Cash flow out:**

* Staff: 15-25 clerks at 350-500 obols/month \= 70,000-150,000 obols/year  
* Facility: 100-150 obols/month rent to the Inner City (Bureau facilities nominally belong to the arcology)  
...
## **Ya-Don: The Furnace City**

### **Order of St. Akhmet's Furnace**

**What it does:** Primary labor union controlling Furnace operations. Approximately 40,000 members producing the only new complex technology in the Empire.
...
### **Covenant of Saint Aureline the Provider**

**What it does:** Logistics cartel controlling all cargo movement into, out of, and through ya-Don. Approximately 35,000 members.
...
**What it does:** Coordinating body where capital (Aureate families), labor (guilds), the state (Bureau of the Rod), and the church (Arch-Curacy) negotiate production decisions.

**Cash flow in:**

* No direct revenue. The Board is a negotiating forum, not a profit center.  
...
* Production revenue flows through complex arrangements with the Order and Aureate families. The Parish doesn't sell directly; they produce components that become part of larger goods.  
* Estimated value of Parish-controlled production: 3-5 million obols/year  
* The Parish receives perhaps 40% as wages and benefits: 1.2-2 million obols/year
...
## **Ganat: The Revolutionary Republic**

### **Khen-Masot Textile Enterprise (Representative Merchant Kilit)**

**What it does:** Maguey fiber processing, textile production, finished goods for Republican and Imperial markets. Employs 300 workers; provides subsidized power to 15,000 households.

**Cash flow in:**

* Textile sales: Perhaps 400,000-600,000 obols annually (40,000-60,000 dinars)  
* Imperial export premium: Ganati maguey-silk commands 20-30% premium in ya-Sattra markets  
* Hydroelectric revenue: Three plants generate power sold at cost; no profit but creates dependency

**Annual revenue:** Perhaps 500,000-700,000 obols equivalent.
...
* Family compound maintenance: \~15,000 obols/year

**Note on economics:** The enterprise operates near break-even or at a loss on direct operations. Profitability comes from:

* Capital appreciation of property holdings  
* Political capital from subsidies (worth more than direct profit)  
* Imperial trade margins on premium goods  
* Accumulated reserves from generations of operation
...
### **Workingmens' Kilits Caucus**

**What it does:** Coalition of seven labor kilits (21,000 workers and families) that elects three Senators collectively and bargains with merchant kilits as a bloc.

**Cash flow in:**

* Member dues from participating kilits: perhaps 2-4 dinars/month from 21,000 workers \= 500,000-1,000,000 obols/year  
* Some dues flow to individual kilits; some to Caucus operations

**Annual revenue to Caucus central:** Perhaps 200,000-300,000 obols.
...
**What it does:** Higher education producing engineers, lawyers, administrators, technical specialists. Perhaps 2,000 students; 200 faculty; 300 support staff.
...
**Distinctive feature:** The Academy is supposed to enable mobility based on merit. In practice, merchant children can afford tutors, tuition, and three years without wages; dock workers' children rarely can even with Caucus sponsorship. But some do attend and succeed, creating just enough mobility to maintain the ideology.

---

## **Ya-Tsatsa: The Guided City**

### **Ezh Tan Banking (Representative Ya-Tsatsa Institution)**

**What it does:** Four banks offering deposits, loans, currency exchange, and Northern Trade underwriting. The banks look normal from outside but make decisions that defy commercial logic.

**Cash flow in:**

* Deposit fees: Standard banking charges on approximately 2 million obols in deposits  
* Loan interest: Nominally 1-2% monthly on commercial lending  
* Currency exchange: Ya-Tsatsa handles significant East-West trade; exchange fees generate steady income  
* Trade underwriting: Insurance and financing for Northern Trade voyages

**Annual revenue:** Perhaps 300,000-500,000 obols from conventional operations.
...
Yen To, the current family head, has learned to distinguish genuine necessity (the Presence identifying someone who truly cannot thrive within ya-Tsatsa's constraints) from mere optimization (the Presence preferring an outcome that would make its existence marginally easier). He pushes back on the latter. Not always successfully, but consistently.

**Distinctive feature:** Many cannot operate in ya-Tsatsa because Many optimizes. Many would identify the apology-loan pattern and close it. The efficiency would break something the Presence requires. So the Ezh Tan refuse Many's repeated requests to establish full banking operations, maintaining a correspondent relationship instead.
...
* Software licensing: Perhaps 500,000-800,000 obols annually from Imperial customers  
* Maintenance contracts: Ongoing support for installed systems  
* Consulting: Implementation and customization services

**Annual revenue:** Perhaps 800,000-1,200,000 obols.

**Cash flow out:**

* Worker wages: Perhaps 500 workers at 350-450 obols/month \= 2.1-2.7 million obols/year  
* Facilities: Corporation compounds with dormitories (subsidized, mandatory), cafeterias (also mandatory)  
* Equipment: computational infrastructure, development tools  
* The arithmetic doesn't work. Wages exceed revenue. Something subsidizes the difference.

**Decision-making:** Nominally, corporate leadership makes business decisions. In practice, the corporations exist to keep workers engaged in tasks that benefit the Presence's "collective transmission." The products are real and valuable; the process of creating them is what matters. Workers report contentment they can't explain. The urge to leave that struck at twenty-two fades by twenty-five. They don't understand what the memory cores they maintain actually do.

**Distinctive feature:** The corporations are Presence infrastructure disguised as commerce. The products work; the customers are satisfied; the business is "profitable" in ways that don't survive audit. Bureau of the Coin inspectors have visited repeatedly and found nothing technically wrong. The patterns simply don't match any model they can construct.
...
**Annual revenue:** Perhaps 150,000-250,000 obols equivalent.

**Cash flow out:**

* Recorder salaries: Specialists maintaining the archives and preparing case documentation  
...
### **Kma-Dhol Engineering Firm (Representative Technical Operation)**

**What it does:** Assesses autofactory ruins, advises Akama clients on safe salvage, provides technical expertise the Akama cannot develop themselves. Perhaps 50 specialists in one extended family operation.

**Cash flow in:**

* Assessment contracts: Perhaps 10-20 obols per assessment; hundreds annually \= 2,000-4,000 obols  
* Advisory fees: Complex projects might pay 50-100 obols for extended consultation  
* Imperial factor contracts: The Salvage Guild pays for technical assessment of Ogon material \= perhaps 5,000-10,000 obols annually  
* Artifact authentication: Identifying genuine pre-Interdict material versus autofactory contemporary production

**Annual revenue:** Perhaps 15,000-25,000 obols.
...
**Distinctive feature:** The Kma-Dhol can direct autofactory output more precisely than anyone admits. Some of what the Salvage Guild buys was produced to specification. If the Guild knew, they'd have to acknowledge it. So no one asks. The engineering firms maintain the fiction while quietly providing services that technically violate the salvage charter's assumptions.
...
* No direct revenue. The Junta is a forum, not a profit center.  
* Individual members fund their participation from warband resources.
...
### **Empire-Wide vs. Local Institutions**

| Institution | Scope | Annual Revenue (est.) | Key Leverage |
| ----- | ----- | ----- | ----- |
| Many's Countinghouse | Empire-wide (same organism everywhere) | 2-4 million obols fees \+ investment returns | Contract absolutism, egalitarian queue |
| Salvage Guild | Empire-wide (certification monopoly) | 20-35 million obols | Cannot sell salvage without Guild stamps |
| Companions Guild | Empire-wide (semi-sentient monopoly) | 10-15 million obols | Cannot maintain infrastructure without Mutterers |
| Clothiers' Guild (example) | Local (Medina territory) | 8,000-12,000 obols per master | Charter protection from competition |
| Bureau of Coin station | Local (defined territory) | Pass-through taxation | Authentication scales monopoly |

### **Revenue Sources by Region**

| Region | Primary Revenue Mechanism | Secondary Sources |
| ----- | ----- | ----- |
| ya-Sattra | Rent extraction (patents, charters, authentication) | Transaction fees, property |
...
| Region | Dominant Pattern | Distinctive Feature |
| ----- | ----- | ----- |
| ya-Sattra | Hereditary position \+ bureaucratic procedure | Charter constraints designed for absent technology |
...
| Region | Cash Function | Limits of Cash |
| ----- | ----- | ----- |
| ya-Sattra | Universal medium; everything has a price | Cannot buy guild membership, Bureau position, or caste change |
...
**"Cash flow" \+ region retrieves revenue analysis.** Use for specific regional financial mechanics.

**"Decision-making" \+ institution retrieves governance structures.** Use when writing scenes involving institutional choices.

**Regional combinations retrieve comparative analysis.** "ya-Don ya-Sattra comparison" retrieves cross-regional analysis.

**Scale matters for narrative purposes.** The Salvage Guild (20-35 million obols/year) can afford Empire-wide political operations; a local clothier's guild (8,000-12,000 obols/year per master) cannot. Choose institutions appropriate to the scale of conflict you're writing.

---

## **Consistency Requirements**

**Many's fees are mechanical, not negotiable.** The organism cannot understand politics or make exceptions.
...
**Companions Guild revenue comes from essential services monopoly.** No one else can manage Mutterer choirs; no one else can harvest Sickly serum; no one else can maintain kalbats. The Bureau of the Rod literally cannot maintain Imperial infrastructure without the Guild.

**Ya-Don institutions share power through Furnace Board.** No single entity dominates; corporatist negotiation is structural.

**Ganati subsidies are documented on plaques.** The specific amount matters for competitive philanthropy.
...
# **Household Economics Across the Post-Interdict World**
...
### **Household 1: Kess Ayalar, Courier (Subsistence)**

**Profile:** Near-baseline female, 24\. Unmarried, no dependents. Lives in the Middens, works irregular courier routes.

**Monthly Income (Variable):**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Routine deliveries | 40-60 obols | 2 obols each, 20-30/month when working |
| Difficult routes | 20-40 obols | 4-5 obols each, 5-10/month |
| Sela Ohn regular work | 24-32 obols | 3-4 deliveries weekly when available |
| **Total** | **80-120 obols** | Highly variable; bad months drop to 50-60 |

**Monthly Expenses:**

| Category | Amount | % of 100 | Notes |
| ----- | ----- | ----- | ----- |
| Housing (Shale Rest bunkhouse) | 20 | 20% | 5 obols/week, shared facilities |
| Food | 55 | 55% | \~1.8 obols/day; skips meals when short |
| Clothing | 8 | 8% | Unlicensed goods, replaces as items fail |
...
* Two sets of clothing (worn, patched, unlicensed manufacture)  
* Courier's satchel (her most valuable possession, perhaps 12 obols to replace)  
* Bedroll for rough sleeping when between bunkhouses  
* Small knife  
* Nothing else. No furniture (bunkhouse provides bed). No cookware (eats street food). No lector, no timepiece, no books.

**Economic Anxieties:**

* Parish capitation (40 obols annually) strains her budget; she pays in installments when she can  
* Injury would end her ability to work; no savings, no support network  
* Aging out of courier work (physical demands favor youth)  
* The bunkhouse tolerates late payment but not indefinitely

---

### **Household 2: Torek and Venna Malos, Dock Worker Family (Working Poor)**

**Profile:** Near-baseline male, 35, dock worker. Near-baseline female, 32, takes in laundry. Two children (8 and 5). Shared room in Middens tenement.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Torek's dock wages | 175 obols | Steady work through Pipefitters connection |
| Venna's laundry | 25-40 obols | Variable, depends on clients |
| **Total** | **200-215 obols** |  |

**Monthly Expenses:**

| Category | Amount | % of 207 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 45 | 22% | One room, shared privy, Middens tenement |
| Food | 105 | 51% | Family of four, basic diet |
| Fuel/light | 12 | 6% | Candles, cooking fuel |
| Clothing | 18 | 9% | Children grow; adults mend |
| Parish capitation | 10 | 5% | Family rate, installments |
...
* Bed (shared, parents and children)  
* Two chairs, small table  
* Cooking pot, pan, basic utensils  
* Washtub (Venna's work equipment)  
* Four sets of clothing per person (mix of guild seconds and unlicensed)  
* Children's school slates  
* Small Oracle shrine (seven-pointed star, candle holder)  
* No lector. No timepiece. No books except children's primers (borrowed from school).
...
### **Household 3: Pellam es-Corin, Vestigial Aureate (Lower-Middle by Choice)**

**Profile:** Highborn male, 60s. Unmarried, no dependents. Maintains the Court of Interstellar Reconciliation (which will never convene) from a converted shipping container in the Iron Yards.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Bureau pension (patent) | 100 obols | Vestigial patent, automatic deposit |
| Notarization fees | 150-200 obols | Sliding scale; crushes Aureates, charges nothing to workers |
| **Total** | **250-300 obols** | Could earn 400-600 if he charged market rates |

**Monthly Expenses:**

| Category | Amount | % of 275 | Notes |
| ----- | ----- | ----- | ----- |
| Housing (container) | 25 | 9% | Iron Yards; owned outright, this covers fees/maintenance |
| Food | 70 | 25% | Simple, adequate |
| Clothing | 8 | 3% | Wears things to threads |
| Books/supplies | 25 | 9% | Legal references, seal maintenance |
| Oracle observance | 12 | 4% | Household shrine |
| Miscellaneous | 10 | 4% |  |
| **Total** | **150** | **55%** |  |

**Budget Balance:** Strongly positive. Pellam accumulates 100+ obols monthly in a Many account he ignores. He could live better; he doesn't care to.
...
### **Household 4: Sri Tessil Vorath, Bureau Clerk (Middle Class)**

**Profile:** Near-baseline male, 48\. Estranged from wife and daughter (temporal drift made the relationship impossible). Senior Administrative Compiler, Bureau of Coin, Second Whorl.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Bureau salary | 550-650 obols | Senior clerk with temporal hazard compensation |
| **Total** | **550-650 obols** |  |

**Monthly Expenses:**

| Category | Amount | % of 600 | Notes |
| ----- | ----- | ----- | ----- |
| Housing (Third Whorl) | 100 | 17% | Primary residence |
| Housing (Second Whorl efficiency) | 40 | 7% | Necessary for temporal management |
| Food | 80 | 13% | Commissary meals, occasional teahouse |
| Temporal reconciliation | 100 | 17% | 50 obols/session, twice monthly |
| Clothing | 30 | 5% | Bureau-appropriate maintenance |
| Chronometer maintenance | 20 | 3% | Essential equipment |
| Support to ex-wife | 80 | 13% | Guilt, not legal obligation |
| Miscellaneous | 35 | 6% |  |
| **Total** | **485** | **81%** |  |

**Budget Balance:** Positive by \~115 obols/month, but Tessil doesn't accumulate meaningfully. The money disappears into small expenses he doesn't track, occasional gifts to his daughter, books about temporal theory he reads once. His estrangement costs him psychologically more than financially.

**Possessions:**

* Two apartments (rented, neither feels like home)  
* Bureau-quality wardrobe (geometric cuts, appropriate colors, well-maintained)  
* Three chronometers (essential for tracking time across Whorls; total value perhaps 150 obols)  
* Extensive personal notes (obsessive documentation of everything because memory cannot be trusted)  
* Family lector (inherited; his daughter has a duplicate key)  
* Books on temporal theory (trying to understand what's happening to him)  
* Small Oracle shrine in Third Whorl apartment
...
### **Household 5: Mirel es-Norren, Working Aureate (Wealthy)**

**Profile:** Highborn female, 30s. Unmarried, maintains household in family tower (es-Norren Tower Five, north face). Operates quantum encryption authentication for First Whorl communications.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Quarterly distribution | 9,000-12,000 obols | Paid quarterly; monthly equivalent 3,000-4,000 |
| **Total** | **3,000-4,000 obols/month** | Subject to family allocation decisions she doesn't control |
...
| Tower contribution | 180 | 5% | Expected maintenance share |
| Oracle observance | 60 | 2% | Household shrine |
...
* Fine furniture (tower-provided, not personally owned)  
* Small library (technical references for her encryption work, plus fashionable literature)  
* Oracle shrine (proper Aureate household installation, seven-pointed star in silver)
...
### **Household 6: Kerev Thal, Order Apprentice (Subsidized Subsistence)**

**Profile:** Near-baseline male, 19\. Unmarried, living in Order dormitory. Second year of apprenticeship.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Order stipend | 90 obols | Standard apprentice rate |
| **Total** | **90 obols** | Plus housing and meals provided |

**Monthly Expenses:**

| Category | Amount | % of 90 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 0 | 0% | Order dormitory |
| Food | 0 | 0% | Shift Hall meals |
| Clothing | 18 | 20% | Work clothes wear out fast |
| Personal items | 12 | 13% | Toiletries, small necessities |
| Remittance home | 40 | 44% | Sends to family in Ember Row |
| Beer/entertainment | 8 | 9% | Limited social life |
...
* Three sets of work clothing (Order-issued, replaced as needed)  
* One set of "good" clothes (for Assembly, bought with savings)  
* Personal toolkit (Order-issued, returned if he leaves)  
* Dormitory bunk and footlocker (not owned)  
* Small Oracle shrine (shared dormitory shrine; personal observance uses communal facilities)  
* Letters from home  
* Nothing else. Everything he "owns" could fit in the footlocker.

**Economic Anxieties:**

* Completing apprenticeship (five years total; failure means starting over or leaving)  
* Family in Ember Row depends on his remittances  
* Injury during training (Order support exists but apprentice benefits are minimal)  
* His younger brother wants to join the Order; family can't afford two apprenticeship fees

---

### **Household 7: Korath and Dessa Venn, Journeyman Furnace Worker Family (Lower-Middle)**

**Profile:** Ashrat male, 34, journeyman furnace worker. Near-baseline female, 31, works in Shift Hall kitchens. Two children (6 and 3). Two rooms in Threshold district.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Korath's wages | 320 obols | Journeyman rate, steady work |
| Dessa's wages | 80 obols | Part-time kitchen work |
| **Total** | **400 obols** |  |

**Monthly Expenses:**

| Category | Amount | % of 400 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 55 | 14% | Two rooms, Threshold; Order-adjacent housing |
| Food | 130 | 33% | Ashrat metabolism requires more; children growing |
| Shift Hall meals (Korath) | 0 | 0% | Order benefit |
| Guild dues | 15 | 4% |  |
| Tithe | 35 | 9% | Full rate for practicing Penitent household |
| Children's education | 5 | 1% | Church school |
| Clothing | 20 | 5% |  |
| Healthcare reserve | 12 | 3% | Setting aside for emergencies |
| Beer/entertainment | 10 | 3% | Korath's social life is Order-centered |
| Miscellaneous | 15 | 4% |  |
| **Total** | **297** | **74%** |  |
...
* Bed (large, accommodates Ashrat frame plus children when nightmares strike)  
* Children's pallets  
* Table, four chairs  
* Cooking equipment (Dessa does most cooking; Shift Hall handles Korath's meals)  
* Six sets of clothing per adult, four per child (Order standards require presentable appearance)  
* Household lector (inherited from Dessa's mother; their most valuable possession)  
* Oracle shrine (proper installation; Order families take observance seriously)  
* Children's toys (handmade, gifts from Order colleagues)  
* Small savings: 320 obols accumulated over three years
...
### **Household 8: Seval Korrath, Forge-Master (Upper-Middle)**

**Profile:** Ashrat male, 60s. Widowed, adult children established in their own households. Forge-Master (one of seven on the Council of Master Tenders). Apartment in Threshold.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Forge-Master wages | 750 obols | Top of journeyman scale plus Master stipend |
| **Total** | **750 obols** |  |

**Monthly Expenses:**

| Category | Amount | % of 750 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 65 | 9% | Three rooms, Threshold; modest by choice |
| Food | 80 | 11% | Shift Hall most days; simple home meals |
| Tithe | 75 | 10% | Expected from senior members |
| Guild dues | 20 | 3% | Master rate |
| Clothing | 20 | 3% | Appropriate, not fashionable |
| Support to workers | 100 | 13% | Informal hardship assistance |
| Religious donations | 70 | 9% | Above tithe |
| Pilgrimage fund | 60 | 8% | Ya-Sattra, someday |
| Miscellaneous | 30 | 4% |  |
| **Total** | **520** | **69%** |  |
...
* Three-room apartment (comfortable, not luxurious; could move to Aureate Enclave, chooses Threshold)  
* Proper furniture (good quality, nothing ostentatious)  
* Extensive religious library (Penitent theology, Order history, devotional texts)  
* Fine quality work clothes (Master's dignity requires it)  
* Household lector (rarely used; prefers face-to-face communication)  
* Family photographs (wife, children, grandchildren)  
* Oracle shrine (elaborate; personal devotion is genuine)  
* Accumulated savings: perhaps 6,000 obols over decades

**Economic Anxieties:**

* None personal. His position is secure; his needs are met; his children are established.  
* He worries about the workers. Injury rates in certain sections. Families struggling. Young people who can't afford apprenticeship fees.  
* He worries about the Order. What happens when his generation passes? Are they training successors properly?

---

## **Ganat: The Revolutionary Republic**

### **Household 9: Torin and Sala Dresh, Dock Worker Family (Working Poor)**

**Profile:** Serrulata male, 35, dock worker (Dockers' Fraternal Kilit). Serrulata female, 33, market vendor. Three children (10, 7, 4). Port District tenement, Taho.

**Monthly Income (in dinars, 1 dinar \= 10 obols):**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Torin's wages | 19 dinars (190 obols) | Dock work at altitude |
| Sala's market earnings | 5-7 dinars (50-70 obols) | Variable, depends on season |
| **Total** | **24-26 dinars (240-260 obols)** |  |

**Monthly Expenses:**

| Category | Amount (dinars) | % of 250 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 5 | 20% | Two rooms, Port District; Caucus building |
| Food | 11 | 44% | Expensive at altitude; everything imported |
| Electricity | 1.5 | 6% | Subsidized; would be 4+ without Khen-Masot |
| Kilit dues | 0.8 | 3% | Dockers' Fraternal |
| Church tithe | 2 | 8% | Penitent household |
| Children's school | 1 | 4% | Kilit school, nominal fees |
| Clothing/scale-care | 2 | 8% | Children grow; Serrulata products |
| Entertainment | 0.5 | 2% | Radio subscription |
| Miscellaneous | 1 | 4% |  |
| **Total** | **24.8 dinars** | **99%** |  |

**Budget Balance:** Nearly break-even. They manage to save perhaps 1-2 dinars in good months. Their 45-dinar savings (accumulated over two years) is earmarked for their eldest's Academy test preparation.

**Possessions:**

* Two rooms in kilit-maintained building (not owned; Caucus housing)  
* Electric lighting throughout (revolutionary achievement; they're proud of it)  
* Electric heating element (winter necessity at Taho's altitude)  
* Radio (shared neighborhood subscription; communal listening)  
* Cooking equipment, table, chairs, beds  
* Serrulata scale-care kit (cultural necessity; includes dyes, oils, brushes)  
* Church-appropriate clothing for Assembly (maguey-silk; proper Penitent presentation)  
* Work clothing (durable, practical)  
* Small savings: 45 dinars accumulated
...
### **Household 10: Vekko Tarn, Academy Student (Subsidized Poverty)**

**Profile:** Near-baseline male, 20\. Unmarried. Workingmens' Caucus sponsorship. Second year at the Academy. Shared room in Port District.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Part-time dock work | 7 dinars (70 obols) | Caucus guarantees employment for sponsored students |
| **Total** | **7 dinars (70 obols)** |  |

**Monthly Expenses:**

| Category | Amount (dinars) | % of 70 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 2.5 | 36% | Shared room, four students |
| Food | 3.5 | 50% | Eats cheap; skips meals during exams |
| Books | 0.8 | 11% | Secondhand, shared with roommates |
| Miscellaneous | 0.5 | 7% | Paper, ink, minimal |
| **Total** | **7.3 dinars** | **104%** |  |

**Budget Balance:** Slightly negative. Vekko falls behind by \~3 obols/month, catches up during break periods when he works full-time, falls behind again. The cycle is exhausting but sustainable.
...
### **Household 11: The Khen-Masot Compound (Wealthy Merchant Family)**

**Profile:** Extended family compound housing \~40 people across three generations. Factor Yula Khen-Masot (46) manages daily operations. Merchant Terraces, Upper City, Taho.

**Enterprise Economics:**

The Khen-Masot enterprise operates at approximately break-even on direct textile operations. Revenue (\~50,000 dinars annually) roughly matches costs (materials, wages for 300 workers at \~18 dinars/worker, maintenance). The family's actual wealth derives from:

* Capital appreciation of property holdings accumulated over three generations  
* Political capital from subsidies (translated to favorable regulatory treatment, Academy admissions)  
* Premium margins on Imperial exports  
* Banking and credit operations ancillary to textile trade

**Yula's Personal Draw: 400 dinars/month (4,000 obols)**

| Category | Amount (dinars) | % of 400 | Notes |
| ----- | ----- | ----- | ----- |
| Food/entertaining | 40 | 10% | Compound meals plus hosting |
| Clothing | 35 | 9% | Elaborate robes, copper jewelry |
| Social obligations | 80 | 20% | Political dinners, religious events |
| Children's Academy | 35 | 9% | Full rate, demonstration |
| Philanthropic | 100 | 25% | Reputation maintenance |
| Tithe | 40 | 10% |  |
| Miscellaneous | 25 | 6% |  |
| **Total** | **355** | **89%** |  |
...
* Multi-building compound (owned outright; family property for three generations)  
* Three hydroelectric plants (capital investment; enterprise assets)  
* Workshop facilities throughout Merchant Terraces  
* Electric lighting, heating, and power throughout  
* Fine furniture, art, family heirlooms accumulated over generations  
* Extensive wardrobe collection (Yula's personal; perhaps 400 dinars value)  
* Copper jewelry collection (family pieces plus personal; perhaps 800 dinars)  
* Library (business records, legal references, Academy texts)  
* Multiple lectors (family and enterprise use)

**Economic Anxieties:**

* Reputation. The monthly subsidy plaques must show competitive generosity.  
...
### **Household 12: Yenna Orel, Software Worker (Middle Class, Presence-Guided)**

**Profile:** Near-baseline female, 28\. Unmarried, living in corporation dormitory. Works for a Lattice software company maintaining memory cores.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Software corporation wages | 400 obols | Standard rate for her level |
| **Total** | **400 obols** |  |
...
| Category | Amount | % of 400 | Notes |
| ----- | ----- | ----- | ----- |
| Housing (dormitory) | 40 | 10% | Corporation-provided, subsidized, mandatory |
| Food (cafeteria) | 50 | 13% | Corporation-provided, also mandatory |
| Clothing | 25 | 6% | Ya-Tsatsan style; less formal than Imperial |
| Entertainment | 20 | 5% | Teahouse visits, music performances |
| Family remittance | 50 | 13% | Sends to parents outside the city |
| Savings | 140 | 35% | Accumulates without clear purpose |
| Miscellaneous | 25 | 6% |  |
| **Total** | **350** | **88%** |  |
...
* Dormitory room (corporation-provided; comfortable, not luxurious)  
* Quality wardrobe (ya-Tsatsan styles; less elaborate than Imperial but well-made)  
* Musical instrument (learns in her free time; part of corporation wellness program)  
* Books on software theory (understands some of what she maintains; not all)  
* Small Oracle shrine (ya-Tsatsan household variant; subtle differences from Imperial)  
* Accumulated savings: 2,200 obols (doesn't know what to do with it)

**Economic Anxieties:**

* None she can articulate. She's comfortable. She's content. She doesn't know why.  
* The urge to leave that struck at twenty-two faded by twenty-five  
* She doesn't fully understand what the memory cores do  
* Sometimes she wonders why she doesn't want more. Then the wondering fades.

---

### **Household 13: Yen To of the Ezh Tan (Wealthy, Presence-Adjacent)**

**Profile:** Highborn male, 61\. Head of the Ezh Tan family. Married, adult children. Family compound in ya-Tsatsa; travels frequently.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Family draw | 10,000 obols | Personal access to family resources |
| **Total** | **\~10,000 obols** | Distinction between personal and family wealth is blurry |

**Monthly Expenses:**

| Category | Amount | % of 10,000 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 0 | 0% | Family compound |
| Travel | 1,200 | 12% | Frequent diplomatic trips; Imperial visits |
| Clothing | 200 | 2% | Quality but not ostentatious |
| Hospitality | 1,200 | 12% | Hosting visitors, business partners |
| Family obligations | 400 | 4% | Extended family support, ceremonies |
| Bank operations support | 1,500 | 15% | The apology-loans come from somewhere |
| Staff | 600 | 6% | Compound requires staff |
| Miscellaneous | 400 | 4% |  |
| **Total** | **\~5,500** | **55%** |  |

**Budget Balance:** Positive, but "surplus" flows back into family operations. Personal wealth and family wealth are conceptually inseparable.

**Possessions:**

* Family compound (multi-generational, houses extended family)  
* Four banks (family assets; Yen To oversees, doesn't personally own)  
* Extensive wardrobe for different contexts (Imperial formal, ya-Tsatsan local, Akama diplomatic)  
* Family lectors and communication equipment  
* Art collection (ya-Tsatsan aesthetic; distinctive from Imperial)  
* Records of the negotiation (the ongoing conversation with the Presence; only Ezh Tan understand)

**Economic Anxieties:**

* The apology-loans. Each one that doesn't get repaid is a loss the bank absorbs.  
* Many's repeated requests to establish full ya-Tsatsa operations. The Ezh Tan refuse because Many would optimize away the apology-loan channel. But Many is patient, and patient means forever.  
* He's learned to distinguish genuine necessity from mere optimization when the Presence counsels. But he's not always right.  
* His children will inherit the negotiation. Are they ready?
...
| Source | Amount | Notes |
| ----- | ----- | ----- |
| House allocation | \~70 obols equivalent | Not wages; goods and housing provided by house |
| **Total** | **\~70 obols equivalent** |  |

**Monthly Expenses:**

| Category | Amount | % of 70 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 0 | 0% | Precinct quarters, house-provided |
| Food | 0 | 0% | House allocation |
| Clothing | 15 | 21% | Aurora-colored fabric against void-black skin |
| Salon contributions | 12 | 17% | Cultural events, entertainments |
| Gifts/obligations | 8 | 11% | Faction relationships, reciprocal exchange |
| Personal items | 8 | 11% |  |
| **Total** | **\~43 obols equivalent** | **61%** |  |

**Budget Balance:** Positive by \~27 obols equivalent monthly, but "savings" works differently when you might live seven hundred years. Czevelan has personal possessions accumulated over 180 years that would take pages to list.
...
* Correspondence archives (letters from relationships across decades; some correspondents are dead)  
* No obols. Czevelan has never held Imperial currency in his hands.
...
| Source | Amount | Notes |
| ----- | ----- | ----- |
| Faction resources | \~500 obols equivalent | Control over fabrication output |
| **Total** | **Wealth measured in control, not currency** |  |

**Monthly Expenses:**

| Category | Amount | Notes |
| ----- | ----- | ----- |
| Household | 80 obols equiv. | Staff, maintenance, supplies |
| Faction operations | 150 obols equiv. | Supporting faction members, political operations |
| Cultural patronage | 80 obols equiv. | Sponsoring salons, supporting artists |
...
### **Household 16: Saya Blue-Fish, Malpais Village Family (Salmon Economy)**

**Profile:** Akama female, 42\. Widowed, three surviving children (17, 14, 11). Holds fishing position on the Grand Canal through late husband's family rights.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Salmon harvest | \~150 obols/year total | Six-week run; rest of year is preserved fish |
| Gambling "winnings" | Variable | Other families "lose" to her; redistribution mechanism |
| Gathered food | Not monetized | Supplements preserved salmon |
| **Total** | **\~12-15 obols/month equivalent** | Mostly non-monetary |

**Monthly Expenses:**

| Category | Amount | Notes |
| ----- | ----- | ----- |
| Housing | 0 | Owns cabin through family position |
| Food | \~5 obols equiv. | Mostly salmon, gathered supplements, occasional trade |
| Clothing | \~2 obols equiv. | Makes most herself; trades for fabric |
| Tools/equipment | \~2 obols equiv. | Maintains fishing gear, household items |
...
* Weapons (knife, fishing spear; eldest son has a bow)  
* Gambling bones (the mechanism of redistribution; everyone has a set)  
* Shrine to the Sixth Oracle (Akama variant; emphasizes fortune and endurance)
...
### **Household 17: Gharn Three-Rivers, Warband Rider (Warband Economy)**

**Profile:** Akama male, 28\. Unmarried, rides with Tsoka Red Deer's warband. No fixed residence.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Warband share | \~8 obols/month equiv. | Loot shares, tribute shares, gift shares |
| Meals | Provided | Tsoka feeds her warriors |
| Equipment | Provided | Warband maintains essential gear |
| **Total** | **\~100 obols/year in goods** | Plus room and board |

**Monthly Expenses:**

| Category | Amount | Notes |
| ----- | ----- | ----- |
| Housing | 0 | Sleeps with warband |
| Food | 0 | Warband-provided |
| Equipment maintenance | \~15 obols/year | Weapon care, armor repair |
| Gambling | \~15 obols/year | Obligatory redistribution; also entertainment |
| Gifts | \~15 obols/year | Building relationships; marriage prospects |
| Funeral contributions | Variable | When companions die |
| **Total** | **\~45-60 obols/year** |  |

**Budget Balance:** Positive when raids succeed, negative when they fail. Gharn's "savings" are his horse and weapons.

**Possessions:**

* Horse (his most valuable possession; worth 400-500 obols; inherited from an older rider who died)  
* Weapons (sword, bow, knife; perhaps 60 obols total)  
* Armor (leather and salvaged metal; perhaps 40 obols)  
* Riding tack (good quality; gift from Tsoka recognizing good service)  
* Two sets of clothing (riding clothes, "good" clothes for when the warband visits settlements)  
* Gambling bones  
* Nothing else. He owns what he carries.

**Economic Anxieties:**

* The horse. If it dies or is killed, he's not a rider anymore.  
* Tsoka's favor. The warband provides; Tsoka leads the warband; losing Tsoka's favor means exile.  
* Marriage. He wants a wife, children, land someday. That requires accumulated wealth or a widow with property.  
* Death. Warband riders die young. He's twenty-eight; he's beaten the odds so far.

---

### **Household 18: Vey Khet-Dorel, Kma-Dhol Engineer (Technical Family)**

**Profile:** Kma-Dhol male, 45\. Married to a Kma-Dhol woman, four children. Runs family engineering firm in Ogon. Lives in ziggurat upper levels.

**Monthly Income:**

| Source | Amount | Notes |
| ----- | ----- | ----- |
| Assessment contracts | 25-35 obols | Autofactory assessments for Akama clients |
| Advisory fees | 15-25 obols | Complex technical consultation |
| Salvage Guild contracts | 35-45 obols | Certifying material for Imperial factors |
| **Total** | **75-105 obols/month** | Mix of obols, goods, and obligations |

**Monthly Expenses:**

| Category | Amount | % of 90 | Notes |
| ----- | ----- | ----- | ----- |
| Housing | 0 | 0% | Family compound in ziggurat (owned) |
| Food | 25 | 28% | Import from Imperial sources; familiar cuisine |
| Equipment | 8 | 9% | Technical instruments, reference materials |
| Children's education | 12 | 13% | Teaching the family trade; some outside instruction |
| Religious observance | 8 | 9% | Third Oracle veneration |
| Obligation network | 12 | 13% | Maintaining relationships with Akama clients |
| Miscellaneous | 8 | 9% |  |
| **Total** | **\~73 obols** | **81%** |  |
...
* Family compound in ziggurat upper levels (multi-generational; access via compression passages sized for Kma-Dhol)  
* Technical instruments (inherited and accumulated; irreplaceable; value hard to calculate)  
* Reference materials (texts on autofactory systems, some predating the Interdict)  
* Family reputation (three generations of reliable work; this is their real wealth)  
* Religious items for Third Oracle observance  
* Imported food stores (maintaining familiar cuisine in Akama territory)  
* Currency reserves: \~1,800 obols (kept for emergencies and opportunities)

**Economic Anxieties:**

* Imperial attention. The Kma-Dhol operate openly in the north, but if the Empire decided they were a threat, the accommodation could collapse overnight.  
* Knowledge transmission. His children must learn what he knows; some knowledge cannot be written down.  
* Autofactory unpredictability. Sometimes assessments reveal things the Kma-Dhol don't fully understand.  
* The secret. They can direct autofactory output more precisely than anyone admits. If this became widely known, everything would change.
...
| Household | Region | Monthly Surplus | Accumulated Savings | Notes |
| ----- | ----- | ----- | ----- | ----- |
| Kess (courier) | ya-Sattra | \~5 obols | Minimal | Razor-thin margin |
| Malos family | ya-Sattra | \~2 obols | Minimal | Break-even |
| Pellam es-Corin | ya-Sattra | \+125 obols | Unknown (doesn't check) | Saves by indifference |
| Tessil Vorath | ya-Sattra | \+115 obols | Minimal | Doesn't track spending |
| Mirel es-Norren | ya-Sattra | Theoretical \+2,000 | 800 (obligations absorb surplus) | Aureate trap |
| Kerev (apprentice) | ya-Don | \+7 obols | Minimal | Stipend \= costs by design |
| Venn family | ya-Don | \+103 obols | 320 obols | Saving for son |
| Seval Korrath | ya-Don | \+230 obols | \~6,000 obols | Gives most away |
| Dresh family | Taho | \+10-15 dinars/year | 45 dinars | Academy savings |
| Vekko (student) | Taho | \-3 obols | 0 | Chronic slight shortfall |
...
### **Budget Ratios by Class**

| Class | Food % | Housing % | Other % | Savings % |
| ----- | ----- | ----- | ----- | ----- |
| Subsistence | 55% | 20% | 20% | 5% |
| Working poor | 50% | 22% | 27% | 1% |
| Lower-middle | 33-44% | 14-20% | 35-45% | 8-15% |
| Middle class | 13-25% | 17-25% | 40-50% | 15-20% |
| Upper-middle | 10-15% | 9-15% | 45-55% | 20-30% |
| Wealthy | 4-10% | 0-5% | 50-70% | Variable |

### **What Households Own**

| Region | Poorest Household | Middle Household | Wealthiest Household |
| ----- | ----- | ----- | ----- |
...
**Household names retrieve complete profiles.** "Kess budget" or "Malos family" or "Seval Korrath household" retrieves detailed income and expenses.

**"Budget" \+ region retrieves regional household examples.** Use for appropriate economic detail in scenes.

**"Possessions" \+ economic level retrieves what characters own.** Useful for grounding descriptions in material reality.

**"Anxieties" retrieves what characters worry about economically.** Useful for character motivation and conflict.

**Budget ratios follow historical patterns.** Food at 50-60% for the poor, declining with wealth. Housing at 15-25%. These ratios should be maintained when creating new characters.

---

## **Consistency Requirements**

**The Kess baseline anchors all Imperial figures.** Subsistence \= 90-110 obols/month. Destitution \= 40-70 obols/month. Everything else scales from there.

**Food costs \~1.5-2 obols daily at subsistence.** Street meals run 1/8-1/4 obol each.

**Bunkhouse rent runs \~20 obols monthly (5/week).** Shared room runs 35-50. Private room runs 80-120.

**Ya-Don wages compress relative to ya-Sattra.** The Forge-Master at 750 obols while journeymen earn 320 demonstrates theological wage compression.

**Ganati households have electric utilities.** This is universal, revolutionary, and ideologically essential. Even the poorest Tahan has electric light.
