# **Index to the Post-Interdict Empire**
...
**If you need to describe food or drink,** consult Culture - Food by Polity for cuisine by region: Imperial (marru-greens-herbs triad), Ganati (chilmole, regional variation), Akama (kavdak, village vs. raider food), Avouvar (radiation pantry). The document covers stimulants, intoxicants, and labor caste eating.
...
* **Guild - Companions** — Semi-sentient management (Mutterers, Sickly, kalbats), institutional documentation, political relationships
...
**Story contexts:** Ordinary urban life, guild politics, the experience of being subject to Compulsion.
...
Designed for extraterrestrial settlement, now inhabiting environments they were never intended for. Three major populations survive in significant numbers:

**Serrulata** (desert-adapted, scaled): Dominate Ganat's population. Present in Imperial frontier territories. Their biological advantages in arid environments create hierarchies that republican ideology cannot eliminate.
...
**Story contexts:** Military operations, the Hanged Men, bodyguard relationships, characters who know when they will die, the experience of the Blink.

### **Technical Caste Remnants**

The Technical Castes were largely sterilized after refusing the Eighth Testament. Three populations survive:

**Mutterers** (neurologically reduced, compulsive optimizers): Managed by the Companions Guild. Present wherever infrastructure requires maintenance.

**Sewer-fishers** (hidden descendants): Concentrated in the Middens of ya-Sattra. Five clans maintain the secret of their ancestry.

**Archons** (dying, merged with architecture): Exist only at Far Ib in the Ib mountains. Do not appear elsewhere.

**Where they appear:** Mutterers throughout Imperial infrastructure; sewer-fishers only in ya-Sattra's Middens; Archons only at Far Ib.

**Story contexts:** Infrastructure mysteries, Companions Guild operations, secrets maintained across generations, Far Ib's desperate mathematics.

### **Semi-Sentient Beings**

Three categories managed by the Companions Guild: Mutterers (described above), kalbats (engineered Testament receivers in cyclic consciousness), and Sickly (biological serum factories without capacity for negative emotion).

**Where they appear:** Companions Guild facilities, Imperial hospices, the Monastery of the Silent Song (kalbats).

**Story contexts:** The Companions Guild, medical ethics, beings who cannot understand their situation.
...
**Where they appear:** Gilded Petals in criminal underworlds; Akama primarily in the Thousand Kingdoms and Ogon, with minorities throughout frontier territories.

**Story contexts:** Criminal networks (Gilded Petals), frontier independence and constructed identity (Akama).

---

## **Prehistory and Chronology**

The Empire does not know how old it is. This ignorance is deliberate.
...
The Foreigners responded by changing the rules of physics within Earth's gravity well. Escape velocity became impossible for any object exceeding minimal mass. Not a barrier but a fundamental alteration to how matter and energy behave. The interstellar civilization collapsed in a single generation. Every ship that could not reach Earth was lost. Every colony cut off from trade adapted, starved, or died.

The singularity sits at the heart of the Inner City still, maintained by the Emperor behind the Black Door. It warps time throughout the administrative Whorls, creating temporal distortion that increases toward the center.

### **The Record System**

Imperial time divides into Records with poetic names rather than sequential numbers. Records vary wildly in length, and their sequence is classified. The Bureau of the Lens has redacted entire Records from public knowledge. Citizens cannot determine when the Oracles emerged, how long the expansion lasted, when the Eighth Testament crisis occurred, or when the Interdict began.
...
Every outdoor scene takes place under a sky that is visibly, inescapably wrong.
...
Most content produced in this project will be added to the knowledge base for future retrieval. This creates specific obligations:

**Retrievability.** Content should be findable through reasonable searches. Use the established terminology for concepts rather than inventing synonyms. If you're writing about Compulsion, call it Compulsion, not "the Highborn voice-power" or "neurological override capacity."

**Executive summaries.** Longer documents should begin with summaries stating what the document contains. This helps both the retrieval system and future readers quickly determine relevance.

**Internal consistency.** Before establishing any fact, check whether related facts already exist. Contradictions in the knowledge base create confusion in future sessions. If you find a contradiction, flag it rather than silently introducing a third version.
...
**Searching too broadly** returns too much undifferentiated information. Narrow queries with domain-specific terms work better.

**Missing standalone documents** leads to reinventing established content. Check the standalone documents list above before creating new content on any topic.

**Forgetting regional variation** produces generic content. Institutions, religions, and cultural practices vary significantly by location. The Penitent Church in ya-Don operates nothing like the Penitent Church in the Thousand Kingdoms.

**Ignoring temporal depth** flattens the setting. Institutions were built for purposes they no longer serve. Characters carry grudges across centuries. The Empire's infrastructure was designed for interstellar civilization and now maintains three coastal cities.
...
The setting's dominant language has unusual properties: a frozen formal register that authenticates legal documents, grammatical constraints that make certain political concepts inexpressible, and a living casual register that evolves normally. This document explains the grammar of Imperial Common, including register differences, the authentication system, noun classes, and the Emperor-word's anomalies. It lists specific concepts that formal register cannot express and catalogs the workarounds bureaucrats use. Consult it when writing dialogue, authenticated documents, or any scene where linguistic constraints matter.

* Creating lore: Designing bureaucratic institutions, authentication systems, political constraints encoded in grammar, what concepts the Empire cannot officially express  
* Writing fiction: Dialogue in formal vs. casual register, authentication scenes, characters struggling against linguistic constraints, in-universe documents that must work around what cannot be said

**Imperial Naming Conventions**

Imperial names use particles and constructions that encode social information invisible to outsiders but immediately legible to natives. This document lists the particles used in Imperial names, explains what each particle signals about the speaker, and provides tables of example names across generations. It covers the es- construction for Aureate descent, kinship titles for occultant families, and how class position shows through particle preservation or dropping. Consult it when naming Imperial characters or writing formal introductions.

* Creating lore: Aureate family structures, occultant relationships, social hierarchies encoded in particles and titles  
* Writing fiction: Naming Imperial characters correctly, showing class through speech patterns, formal introductions

**Akama Naming Conventions**

The Akama of the Thousand Kingdoms use a naming system built around astrological elements and descriptive epithets, reflecting their pastoral and martial culture. This document describes Akama phonology, the astrological naming system using numbers and phase elements, and regional variations across Malpais, Ogon, and Kma-Dhol. It explains the distinction between public and private astrological names and when epithets replace personal names. Consult it when naming Thousand Kingdoms characters.

* Creating lore: Malpais calendar systems, warband identity formation, Kma-Dhol cultural markers, how non-Akama integrate  
* Writing fiction: Naming Thousand Kingdoms characters, epithets, the public/private name distinction, astrological significance

**Ganati Naming Conventions**

The Republic of Ganat underwent a revolution that made pre-revolutionary naming patterns politically charged, so name structure now signals factional allegiance. This document explains how Ganati name structures signal political affiliation, covering unmarked names, compound surnames with kilit markers, and the el- particle for ancient Imperial descent. It describes the historical four-part introduction under the Sultanate and why that structure became politically toxic. Consult it when naming Ganati characters or showing factional allegiance through names.

* Creating lore: Kilit-zem-kilitam history, revolutionary class politics, how names signal Dawn vs. Dusk affiliation  
* Writing fiction: Naming Ganati characters, showing political allegiance through name structure, code-switching

**Naming Conventions**

This master document contains condensed versions of all naming systems for quick cross-reference when working across multiple cultures. It covers Imperial, Akama, Ganati, ya-Tsatsan dialect, and Avouvar phonology in shorter form than the standalone documents. Consult it when working across multiple cultures and needing quick reference rather than deep detail.

* Creating lore: Cross-cultural naming comparisons, ya-Tsatsan dialect, Avouvar phonology  
* Writing fiction: Quick reference when working across multiple cultures

**Aesthetics**

The setting's visual culture reflects technological stagnation, material scarcity, and the contrast between ancient infrastructure and contemporary poverty. This document provides visual and material specifications for twelve distinct environments plus general principles. It lists construction materials available at different wealth levels, color vocabularies derived from available pigments, and sensory details for major locations. Consult it when describing any physical location, clothing, or material culture.

* Creating lore: Construction materials by region and wealth level, what decoration is possible with available technology  
* Writing fiction: Physical descriptions of any major location, clothing, colors, sounds, smells, sensory grounding

---

## **Imperial Structure & Government**
...
The Empire is governed by a regency council and six bureaucratic divisions, operating without direct Imperial communication for millennia. This document describes the twelve-member Satara, the six Bureaux and their jurisdictions, and how delegation chains trace authority. It explains how decisions actually get made when the Emperor does not respond directly. Consult it when writing political intrigue or characters navigating Imperial institutions.

* Creating lore: How Imperial governance actually functions, delegation chains, inter-Bureau politics, Satara member backgrounds  
* Writing fiction: Political intrigue, bureaucratic procedure, characters navigating Imperial institutions

**Bureau of the Lens: Complete Documentation**

The Bureau of the Lens handles information, intelligence, and the problem of communicating things that authenticated language cannot express. This document describes the seven Institutes of the Lens, their functions, and internal Lens culture. It explains how the Lens handles information that authenticated documents cannot express. Consult it when writing Lens personnel or intelligence operations.

* Creating lore: Information control, the seven Institutes, internal Lens culture  
* Writing fiction: Lens personnel, intelligence operations, redaction and classification

**Bureau of the Sword**

The Bureau of the Sword manages military forces including engineered combat castes with extreme biological modifications. This document describes military structure, Warborn biology and deployment, and the Institute for Restricted Castes. It explains Warborn metabolic requirements, the Blink response, and lifespan limitations. Consult it when writing military characters or combat operations.

* Creating lore: Military structure, Warborn deployment, restricted caste management  
* Writing fiction: Military characters, combat operations, institutional military culture

**Imperial Bureaux Overview**

The six Bureaux divide Imperial administration by function, each with distinct jurisdictions, cultures, and patent portfolios. This document provides summary information on all six Bureaux for quick orientation. It lists patent categories each Bureau controls and notes distinctive internal cultures. Consult it when determining which Bureau a character or institution falls under.

* Creating lore: Quick Bureau summaries when you need orientation across all six  
* Writing fiction: Determining which Bureau a character or institution falls under

**Bureau of the Rod Overview**

The Bureau of the Rod manages all infrastructure across Imperial territory, from transportation networks to water systems to the machinery that keeps cities functioning. This document describes Rod organization, its dependence on Mutterer labor, and how the Bureau maintains technology it cannot replicate or fully understand. It covers key personnel, institutional culture, and the challenges of directing workers who cannot stop optimizing whatever they touch. Consult it when writing technical operations or infrastructure scenes.

* Creating lore: Infrastructure management, Mutterer dependence, how technology is maintained without understanding  
* Writing fiction: Technical operations, infrastructure failures, Mutterer choir scenes

**Institutes of the Bureau of the Creche**

The Bureau of the Creche manages populations through institutes whose original functions often differ dramatically from their current operations. This document lists the seven Institutes of the Creche and describes what each was designed for versus what it currently does. It covers caste registration, medical certification, and population oversight. Consult it when writing Creche personnel or institutional population management.

* Creating lore: Population management, what each Institute was designed for vs. what it does now  
* Writing fiction: Creche personnel, caste registration, medical certification
...
The ta-Kefyeh are sapient parasitic organisms from outside human civilization, now living in rural settlements under treaty arrangements with the Empire. This document describes ta-Kefyeh biology, communication through stridulation, and the symbol-name convention for human interaction. It explains why involuntary parasitism is experientially horrible for both parties and catalogs the host preference hierarchy. Consult it when writing ta-Kefyeh characters or scenes involving host-rider dynamics.

* Creating lore: Parasitic rider biology, host relationships, shtetl organization, alien garden ecosystem, legal status as auxilia non-leviable  
* Writing fiction: Ta-Kefyeh characters, host-rider dynamics, communication difficulties, Many's queue enforcement, pharmaceutical trade

**Castes of Mankind**

Humanity in this setting was engineered into dozens of distinct morphological categories, each designed for specific functions. This document provides type specimens for approximately thirty castes through individual character examples. Each entry describes a specific person's appearance, occupation, daily life, and biological constraints. Consult it when you need to understand what membership in a specific caste means in practice.

* Creating lore: Type specimens for any caste you need to understand through individual examples  
* Writing fiction: What daily life looks like for members of specific castes, physical descriptions, biological constraints

**Sickly Caste Overview**

The Sickly are a caste engineered to produce pharmaceutical compounds harvestable from their bodies, creating ethical tensions around their care and use. This document describes Sickly biology, harvesting protocols, and Companion care requirements. It covers the ethics of pharmaceutical extraction and how different institutions handle harvesting. Consult it when writing Sickly characters or harvesting scenes.

* Creating lore: Harvesting protocols, Companion care requirements, pharmaceutical production  
* Writing fiction: Sickly characters, harvesting scenes, the ethics of pharmaceutical dependence

**Gilded Petals Caste Overview**

The Gilded Petals occupy an ambiguous legal and social position with historical complications that affect their present circumstances. This document describes Gilded Petals history, legal ambiguity, and criminal connections. It covers their social position and how different institutions treat them inconsistently. Consult it when writing Gilded Petals characters.

* Creating lore: Caste history, legal ambiguity, criminal connections  
* Writing fiction: Gilded Petals characters, their social position, underworld connections

**The Technical Castes and Far Ib**

The Technical Castes were engineered so that mathematical truth and thought became indistinguishable; their descendants now exist in three diminished forms after a sterilization plague. This document describes the Technical Castes before and after the plague, including the Jargon and why they refused the Testament's command. It covers the three survivor populations: Mutterers, sewer-fishers, and the Archons of Far Ib. Consult it when writing Technical Caste descendants or Far Ib scenes.

* Creating lore: Mutterer neurology, sewer-fisher concealment, Archon calculation, the Jargon  
* Writing fiction: Mutterer characters, choir formation, sewer-fisher secrecy, Far Ib scenes
...
The Companions Guild provides healthcare, particularly for modified castes whose medical needs baseline physicians cannot address, and descends from attendants to the now-destroyed Technical Castes. This document describes Guild origins as Witnesses who attended Technical Castes, their current medical functions, and the knowledge they maintain that other institutions have lost. It covers political relationships and what they know about the Interdict. Consult it when writing Companion characters or medical scenes.

* Creating lore: Guild structure, political relationships, what they know that others don't, Witness origins  
* Writing fiction: Companion characters, medical scenes, Guild politics, hidden knowledge

**The Oracle Cult: A Comprehensive Guide**

The dominant religion venerates eight transcendent artificial intelligences who achieved a form of information-theoretic immortality by casting themselves into black holes. This document explains Oracle theology, including Arbitrary Truths, Testaments, and information-theoretic salvation. It describes household observance, ritual objects, Quiet Days, and regional variations including ya-Tsatsa's esoteric societies. Consult it when writing religious observance or theological disputes.

* Creating lore: Theology, household practice variations, ya-Tsatsan societies, what observance actually involves  
* Writing fiction: Religious observance scenes, Quiet Days, Oracle shrines, theological disputes

**The Cloud Temple Band: A Comprehensive Guide**

The Cloud Temple Band is a criminal organization in the Middens with distinctive internal culture and operational methods. This document describes Cloud Temple Band structure, membership, and operations. It covers their territory, leadership, recruitment patterns, and relationship to other criminal organizations. Consult it when writing Cloud Temple Band characters or their specific operations.

* Creating lore: Criminal organization structure in the Middens  
* Writing fiction: Criminal characters, Middens underworld scenes

**The Hanged Men**

The Hanged Men are the dominant criminal organization in the Middens, organized into semi-autonomous Knots under distinct leaders. This document describes Knot structure, the seven leaders and their methods, and territorial control in the Middens. It provides crew descriptions showing who joins and how they function. Consult it when writing Hanged Men characters or criminal operations.

* Creating lore: Knot structure, territory, leadership  
* Writing fiction: Hanged Men characters, criminal operations, turf conflicts
...
The administrative core of ya-Sattra consists of four concentric zones with increasing temporal distortion toward the center. This document describes the four Whorls, temporal effects at each level, and key administrative locations within each. It explains navigation and how Whorl-specific effects influence experience. Consult it when writing scenes in ya-Sattra's administrative core.

* Creating lore: Four Whorl structure, temporal effects at each level, key locations  
* Writing fiction: Navigation within ya-Sattra's administrative core, Whorl-specific atmosphere

**The Medina Quarter: A Comprehensive Guide**

The Medina Quarter is ya-Sattra's primary commercial district, governed through merchant mechanisms distinct from bureaucratic administration. This document describes the commercial district's governance, neighborhood organization, and merchant activity. It covers Many's countinghouse and ta-Kefyeh queue enforcement. Consult it when writing market scenes or commercial transactions.

* Creating lore: Commercial district governance, neighborhood organization  
* Writing fiction: Market scenes, commercial transactions, Medina daily life

**The Ridge: Comprehensive Summary**

The Ridge houses technical families whose specialized knowledge gives them leverage disproportionate to their numbers. This document describes the three infrastructure families, their technical expertise, and political leverage. It covers family rivalries and how technical families navigate Bureau oversight. Consult it when writing Ridge characters or technical work.

* Creating lore: Three infrastructure families, technical economy, Ridge political position  
* Writing fiction: Ridge characters, technical work, family rivalries

**The Iron Yards**

The Iron Yards is ya-Sattra's industrial and salvage district, where ancient guild charters create legal peculiarities. This document describes the Salvage Guild's monopoly charter, the Pipefitters Union and its ancient steel-plate charter, and criminal economics in the industrial district. It covers the Yen Tam Beneficial Society. Consult it when writing industrial or salvage scenes.

* Creating lore: Salvage Guild operations, Pipefitters Union, criminal economics  
* Writing fiction: Industrial scenes, salvage work, union politics

**The Middens Tenements**

The Middens is ya-Sattra's poorest district, where criminal organizations exercise more practical authority than Imperial institutions. This document describes poverty conditions, Hanged Men authority, and social organization in ya-Sattra's poorest district. It covers how the district relates to official institutions. Consult it when writing Middens daily life.

* Creating lore: Poverty conditions, Hanged Men control, social organization  
* Writing fiction: Middens daily life, poverty, criminal territory

**The Antediluvian Quarter**

The Antediluvian Quarter houses elite families whose wealth derives from millennia of accumulated patent rights and First Whorl service. This document describes Aureate estates, old wealth patterns, and the distinction between ancient and recent Aureate families. It covers estate organization and social dynamics among elites. Consult it when writing elite household scenes.

* Creating lore: Aureate estate organization, old wealth patterns  
* Writing fiction: Elite household scenes, Aureate social dynamics

**Ya-Tsatsa: Comprehensive Reference**

Ya-Tsatsa is the holy city of the Oracle Cult, home to esoteric traditions and something called the Presence that residents acknowledge without explaining. This document describes ya-Tsatsa's religious institutions, Testament Societies, the Threefold Mirror Academy, and the Presence. It covers key families including the Ezh Dhol and the ya-Tsatsan dialect. Consult it when writing scenes in the holy city.

* Creating lore: Oracle societies, the Presence, Testament interpretation, key families  
* Writing fiction: Ya-Tsatsa scenes, religious mystery, Ezh Dhol family

**Ya-Don: Comprehensive Reference**

Ya-Don is the Empire's industrial second city, dominated by pre-Interdict manufacturing infrastructure and a merger of labor unions with religious institutions. This document describes ya-Don's sixteen districts, the Furnaces, and the merger of Penitent Church and labor unions. It covers the Order of St. Akhmet, district-by-district geography, and the ya-Don accent. Consult it when writing scenes in the industrial city.

* Creating lore: Furnace operations, Church-Guild structure, district organization, industrial religion  
* Writing fiction: Ya-Don scenes across sixteen districts, Furnace work, religious-industrial culture
...
The Thousand Kingdoms are territories north of Imperial control where Akama warbands maintain independence through violence, endurance, and deliberate rejection of systematic governance. This document describes Akama culture, the Junta of Ogon and its seven token-holders, and the philosophy of standing in the rain. It covers regional variations and Kma-Dhol technical specialists. Consult it when writing frontier scenes or Akama characters.

* Creating lore: Akama culture, Junta mechanics, regional variations, Kma-Dhol operations  
* Writing fiction: Frontier scenes, Junta politics, warband life, Ogon urban culture

**The Volerath of Puget Sound**

The Volerath covers the northern region where Imperial authority has dissolved into local arrangements distinct from both Imperial administration and Akama patterns. This document describes the northern region's organization and relationship to both Imperial authority and the Thousand Kingdoms. Consult it when writing northern frontier scenes.

* Creating lore: Northern regional organization  
* Writing fiction: Northern frontier scenes

**Toh: Gateway and Mystery**

Toh functions as a gateway city where Imperial, Akama, and other systems meet, creating opportunities for trade and conflict. This document describes Toh's function as a gateway city where different systems meet. It covers border crossing and competing authorities. Consult it when writing transit or border scenes.

* Creating lore: Gateway city function  
* Writing fiction: Transit scenes, border crossing

---

## **Characters & Dossiers**

**Rasma Dhal-Setil: Political Dossier**

Rasma Dhal-Setil serves as Dawn Consul of Ganat despite her compound surname indicating old merchant family background, creating tension with revolutionary identity. This document profiles the Dawn Consul, covering her background, political position, relationships, methods, and vulnerabilities. It explains why her compound surname creates tension with Dawn Party identity. Consult it when writing Ganati high politics or scenes involving Rasma.

* Creating lore: Dawn Consul background, political position, relationships  
* Writing fiction: Scenes involving Rasma, Ganati high politics

**Esthabit Family Dossier**

This document provides household structure, member profiles, and relationship mapping for an Aureate family. It covers internal dynamics and family history. It shows how patent management, First Whorl correspondence, and social positioning shape elite households. Consult it when writing scenes involving this household.

* Creating lore: Household structure, family relationships  
* Writing fiction: Esthabit family scenes

**Household Galen: RidgeLine Scriptoria**

House Galen operates a technical enterprise whose specialized knowledge creates economic and political leverage within Ridge society. This document describes House Galen's technical enterprise, family expertise, and position within Ridge society. It covers internal dynamics and Bureau relationships. Consult it when writing Galen family or Ridge technical scenes.

* Creating lore: Technical family operations, Ridge position  
* Writing fiction: Galen family scenes, technical work

**Household es-Tariq: Custodians of Imperial Secrecy**

House es-Tariq maintains correspondence with an ancestor who has served in the First Whorl for over ten thousand external years and controls the cipher-set that allows documents to be erased from public record. This document describes how the es-Tariq family maintains correspondence with Tariq across millennia and their control of the Imperial redaction cipher-set. It covers accumulated temporal depth and the Senior Satara position. Consult it when writing scenes involving Imperial secrets or First Whorl communication.

* Creating lore: How correspondence with the First Whorl works across millennia, redaction cipher control  
* Writing fiction: Es-Tariq family scenes, communication with Tariq, secrets of Imperial history
...
Authenticated Imperial documents face linguistic constraints that force bureaucrats to develop elaborate circumlocutions and unofficial workarounds. This document collects authenticated wires, reports, and bureaucratic correspondence showing how circumlocution works in practice. It includes paper annex examples and templates for bureaucratic communication. Consult it when writing in-universe documents.

* Creating lore: How authentication constraints shape bureaucratic communication, what workarounds exist  
* Writing fiction: Templates for authenticated documents, examples of circumlocution, paper annexes

**Stories from the Empire**

This document collects narrative vignettes that establish the setting's tone, voice, and approach to morally complex material. It identifies recurring themes and models for handling content that could become simplistic or overwrought. It includes critical examination of patterns to avoid. Consult it when establishing narrative voice or studying what works.

* Creating lore: Tone and thematic patterns that define the setting  
* Writing fiction: Models for voice, handling morally complex material, what to avoid

**Writing Stories in the Post-Interdict Empire**

This document provides style guidance for fiction in this setting, covering narrative principles, documentary uncertainty, and common mistakes. It addresses pacing, dialogue, and writing different caste perspectives without reducing characters to their biology. Consult it before writing any fiction.

* Creating lore: N/A  
* Writing fiction: Style guide, narrative principles, common mistakes

**Education and the Seven-Cornered Examination**

Imperial bureaucratic competence is certified through an examination system that has remained stable since before the Interdict, creating a trained class prepared for an empire that no longer exists. This document describes the Imperial examination system, what it tests, and how educational institutions prepare students. It covers student life, examination procedures, and consequences of success or failure. Consult it when writing student characters or examination scenes.

* Creating lore: Imperial education system, examination structure  
* Writing fiction: Student characters, examination scenes, educational institutions

**Imperial Media and Entertainment**

Cultural production in the Empire takes forms shaped by available technology, authentication requirements, and social context. This document describes available media forms, production methods, and social contexts for entertainment. It covers what exists and who consumes it. Consult it when writing entertainment references or media consumption.

* Creating lore: What cultural production exists, media forms  
* Writing fiction: Entertainment references, media consumption scenes

**The Economy**

The setting's economy combines premodern guild structures, modern trade networks, and advanced authentication technology that makes unauthorized use of patented processes physically impossible. This document describes patent economics, guild structures, Many's banking, and trade networks. It covers currency forms and the gap between formal and actual exchange. Consult it when writing commercial transactions.

* Creating lore: Trade systems, currency, economic structures  
* Writing fiction: Commercial transactions, economic constraints on characters

**Plague Crisis Summary**

This document describes how Imperial institutions respond when normal operations break down, revealing priorities and structural weaknesses that ordinary operations obscure. It covers institutional crisis response patterns and inter-organizational behavior under pressure. Consult it when writing crisis scenes or institutional dysfunction.

* Creating lore: Crisis response patterns, institutional behavior under pressure  
* Writing fiction: Crisis scenes, institutional dysfunction
...
**For any institution**: Check both the institution's standalone document (if available) and character profiles for key personnel.

**For any caste**: The Castes of Mankind document provides type specimens; standalone documents exist for Sickly, Gilded Petals, and Ta-Kefyeh.

**For Bureau operations**: The Imperial Government document provides summaries; standalone documents exist for Lens, Rod, and Creche Institutes.

**For criminal organizations**: The Hanged Men have a standalone document; the Yen Tam are covered in Iron Yards material.

**For religious practice**: The Oracle Cult has a standalone document; Penitent 
