...
def main():
    ...
    if not args.dry_run:
        ...
        print()
        print("=" * 60)
        print("SESSION START GUIDANCE")
        print("=" * 60)
        print()
        print("If the user hasn't specified what they want to do, offer:")
        print()
        print("TO BEGIN A SCENARIO:")
        print("  - Describe a character concept (caste, occupation, situation)")
        print("  - Name a location to explore")
        print("  - Describe a situation or problem to navigate")
        print()
        print("SUGGESTED ENTRY POINTS (search glossary for details):")
        print("  - The Lattice Translator scenario (active scenario document)")
        print("  - Life in the Middens tenements")
        print("  - Republican politics in Ganat")
        print("  - A Technical Caste worker in Far Ib")
        print("  - Akama nomads of the Thousand Kingdoms")
        print()
        print("Run: python3 glossary.py lookup '<term>' for any unfamiliar concept")
        print("=" * 60)
