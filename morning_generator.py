...
MORNING_EVENTS = {
    ...
    "senna": [
        ...
        "Senna is still in bed—unusual. She says she's fine.",
    ...
    "building_sounds": [
        ...
        "Water rushing through pipes somewhere—more than usual.",
    ...
    "outside": [
        ...
        "Fog today. The air is thick—too many bodies, too much water boiling for noodles. It has to go somewhere. Water beads on your window.",
