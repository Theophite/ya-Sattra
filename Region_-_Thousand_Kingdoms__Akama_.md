...
The Akama caste, philosophy, and identity are documented separately. See: `Caste_-_Akama.md`

## **Naming Conventions**

Akama naming patterns are documented separately. See: `Guide_-_Akama_Naming_Conventions.md`

## **The Ogon Junta**

The governing structure of Ogon is documented separately. See: `Government_-_The_Ogon_Junta.md`
...
Akama military organization is covered in the military guide. See: `Guide_-_Militaries_and_Warfare.md` (Part IV: The Thousand Kingdoms)

## **Destriers**

The carnivorous mounts are documented separately. See: `Creature_-_Destriers.md`

## **Locations**

Major locations in the Thousand Kingdoms are documented separately:

- **Ogon** — The autofactory city, nearly a million inhabitants. See: `Location_-_Ogon.md`
- **The Northern Frontier** — Where Imperial sovereignty dissolves into fiction. See: `Location_-_Northern_Frontier.md`
- **The Malpais** — Akama culture without compromise. See: `Location_-_The_Malpais.md`
- **Ghaur-Dan** — Astal settlement in lava rock. See: `Location_-_Ghaur-Dan.md`

## **The Kma-Dhol**

The sewer-fisher population of the Thousand Kingdoms is documented with their Imperial counterparts. See: `Caste_-_Sewer-Fishers.md` (section: The Kma-Dhol)
...
Examples of Akama artistic expression are documented separately. See: `Culture_-_Akama_Arts.md`
