...
**Naming Conventions** provides detailed guidance on Akama phonology, public names, astrological names (both family and private), descriptive epithets, and how Imperial-origin individuals integrated into Akama society retain different naming patterns.

**The Junta of Ogon** describes the seven-token governance system, the Slab gatherings, voting mechanics, and provides detailed profiles of all current members: Som es-Vol, Tsoka Red Deer, Ataru Blackfish, Bal Tama, Iron-Rain, Imek Stone-Foot, and Vey Nine Birds.

**Economics and Military** covers the salmon economy, gambling as redistribution mechanism, destrier biology and economics, and warband organization.

**Regional Sections** describe Ogon itself, the northern frontier's gradual dissolution of Imperial authority, Malpais village life, Ghaur-Dan and the Astals, and the Kma-Dhol's open operation in the north.

**Factory-Singing and Arts** addresses the region's distinctive relationship with autofactories and provides examples of Akama artistic expression.
...
* Writing any scene set north of Imperial control  
* Introducing Akama characters or warbands  
* Understanding how frontier politics differ from Imperial governance  
* Creating named Akama characters (the naming conventions section is essential)  
* Writing about the Junta, Ogon, or the autofactory  
* Understanding the Kma-Dhol's different status in the north versus the Empire

**Search for other documents when:**

* You need Akama or Warborn caste biology (search caste documents)  
* You need sewer-fisher origins and Technical Caste history (search Sickly Caste or Technical Caste documents)  
* You need Imperial political structures for contrast (search Imperial Government)  
* You need information on the Republic of Ganat (search Ganat documents)  
* You need Oracle Cult theology beyond genealogical claims (search Oracle Cult documents)
...
**The Tamas span multiple sections.** The family appears in Bal's profile, in the historical "Five Highborn Crisis" section, and in discussions of how they shape Junta membership through elimination rather than selection. Search "Tama" broadly if writing about their influence.

**Kma-Dhol retrieves northern context.** The Kma-Dhol section here describes their open operation in Ogon; their hidden existence in Imperial territories is documented in sewer-fisher and Sickly Caste documents.

**Factory-singing has regional variants.** Northern cargo cults, Kma-Dhol technical methods, and Akama political uses are all described. Search "factory-singing" for this material.

---

### **Consistency Requirements**

**The seven Junta members are fixed.** Som es-Vol, Tsoka Red Deer, Ataru Blackfish, Bal Tama, Iron-Rain, Imek Stone-Foot, and Vey Nine Birds have established ages, capabilities, relationships, and motivations. Do not contradict these.

**Akama philosophy has specific content.** "Standing in the rain" means endurance without complaint. Direct aid is theft of sacred experience. Witnessing suffering honors the sufferer. Luck is justice. These are not interchangeable platitudes.

**Naming conventions encode information.** Astrological surnames (Thirteen-Hawk, Nine Birds) indicate Malpais cultural roots. Epithets (Red Deer, Blackfish, Stone-Foot) are earned and carry meaning. Imperial names (Bal Tama) indicate non-Akama genetic origin with full cultural integration. Private astrological names are never used publicly.
...
**Treating Akama as primitive Imperials.** They are not failed civilization but alternative philosophy. They reject systematic governance deliberately, viewing personal power and endurance as more honest than bureaucratic fiction.

**Forgetting the dual Akama requirement.** Being Akama requires both reproductive compatibility (producing viable Akama children) AND cultural participation (living the life, standing in the rain). Genetics alone or culture alone is insufficient.

**Misunderstanding gambling's function.** The games are openly rigged. Everyone knows. Losing is how you give resources to people who need them without violating the principle that direct aid is theft of sacred experience.

**Making the Junta a government.** It is coordination between military powers, not systematic administration. No laws, no bureaucracy, no monopoly on violence, no sovereignty claim. Decisions work because members choose to follow them, not because enforcement mechanisms exist.

**Treating northern Kma-Dhol like Imperial sewer-fishers.** In the north, they operate openly as recognized technical specialists with religious legitimacy. They are not hidden. Their capabilities are known and respected.
...
### **Oracle Genealogy and Sacred Ancestry**
...
Akama funeral practice embodies their philosophy completely. Bodies are placed atop stone cairns, naked except for weapons. Companions tell laconic, funny stories: "Remember when Gan tried to ride two destriers at once and ended up hanging from a tree by his belt?" After each story, the teller places a small object on the cairn. Then everyone leaves. The body remains for destriers and scavenger birds.

The funeral ends with the following: "He is unlucky, so he is dead. We are lucky: his body feeds us."

# **Akama Naming Conventions**

This guide outlines the structural and phonetic parameters for generating or analyzing names associated with the Akama cultural complex of the Thousand Kingdoms. These conventions apply primarily to ethnic Akama and Malpais-descended populations, though Imperial-origin individuals integrated into Akama society follow variant patterns.

## **I. Phonology and Sound Patterns**

Akama phonology draws from influences somewhere between Tibeto-Burman and Turkish languages, producing a harsh, throat-focused sound that most Imperial and Ganati speakers find difficult to replicate without childhood training.

### **Consonant Patterns**

The consonant inventory emphasizes:

* **Harsh clusters:** ts, gh, kh, dh  
* **Hard stops:** k, t, d (prominently featured)  
* **Liquids and nasals:** r, l, m, n (frequent)  
* **Glottal stops:** Multiple stops within single words are common

The phrase "standing in the rain" (*ghol krom dhaal*) exemplifies typical consonant clustering requiring three distinct glottal stops.

### **Vowel Patterns**

Vowels tend toward:

* **Dark vowels:** a, o, u predominate  
...
Personal names range from monosyllabic to trisyllabic, with disyllabic forms most common.

**Observed Examples:**

* Monosyllabic: Som, Gan, Khol, Tam, Vey  
* Disyllabic: Tsoka, Ataru, Imek, Ghom, Khol, Sevak, Kelam, Gorin  
* Trisyllabic: Kherzen, Tselkor, Buragh

## **II. Personal Names (Public)**

Public personal names function as the standard address form in most contexts. These names are not calqued and, though they derive from Akama words, are not considered to have lexical meaning outside their use as names.
...
**Usage:** These serve as the basic identification in public contexts, business dealings, and formal address. They may be used alone or combined with other naming elements depending on context and social relationship.

## **III. Astrological Names**

The Akama employ a complex phasal calendar combining 7-13 day phase counts with cycles of named phases related to Malpais animals, plants, and natural phenomena. This calendar system generates two types of astrological names.

### **Family Astrological Names**

**Structure:** Number \+ Phase Element

**Function:** Captures the astrological character of the family line. These are publicly used surnames, particularly common in the Malpais and among Kma-Dhol populations.

**Documented Examples:**

* Thirteen-Hawk (as in Khol Thirteen-Hawk)  
* Nine Birds (as in Vey Nine Birds)
...
**Cultural Context:** These names carry lexical meaning and astrological significance. The specific day and phase combination is believed to reflect the family's essential character and fortune. Certain combinations are considered particularly auspicious or inauspicious, influencing marriage negotiations and alliance formation.

### **Private Astrological Names**

**Structure:** Number \+ Phase Element (same pattern as family names)

**Function:** Reflects the specific day on which a child was named (not necessarily born). Each individual receives a private astrological name used only among family members.

**Usage Rules:**

* Used exclusively in private, familial contexts  
* Never employed in public address or formal settings  
* Maintained even by families who have adopted non-astrological public surnames  
* Persist among Akama-cultured populations in Ogon who otherwise use epithets or Imperial names

**Naming Timing:** Children born on unlucky days are not named on their birth date. The family waits until the next day with favorable fortune, ensuring the child receives an auspicious private name regardless of their actual birth timing.

**Cultural Significance:** The persistence of this practice even among populations who have abandoned other traditional naming conventions demonstrates its deep cultural importance. Families without astrological surnames still use these private names among themselves, maintaining intimate connection to traditional calendrical systems.

## **IV. Descriptive Epithets**

Epithets are earned or descriptive names common in Ogon and among warbands, often replacing or supplementing astrological surnames.

**Structure:** Personal Name \+ Epithet

**Function:** These descriptive additions may reference physical characteristics, achievements, personal qualities, or significant events. They carry lexical meaning.
...
*Standard form:* The epithet follows the personal name (Imek Stonefoot), functioning similarly to a surname while remaining descriptively meaningful.
...
## **VI. Social Context and Usage**

### **Public vs. Private Names**

Akama naming operates on two parallel tracks:

* **Public sphere:** Personal names, astrological surnames (when used), epithets, or Imperial names  
* **Private sphere:** Astrological personal names used exclusively among family

This dual system persists even among populations who have largely abandoned traditional practices in other areas. An Ogon merchant with an Imperial name and no astrological surname still uses a private calendrical name with their children and siblings.

### **Regional Variations**

**Malpais populations:** Heavily favor astrological surnames combined with personal names. The traditional pattern remains strongest here, with families maintaining detailed calendrical records and consulting them for major decisions.

**Ogon populations:** More likely to use epithets as surnames or adopt Imperial naming patterns. However, private astrological names remain nearly universal in family contexts.

**Kma-Dhol populations:** Consistently use astrological surnames even when integrated into Ogon society. The technical specialist community maintains traditional naming as cultural marker.

**Warband-affiliated populations:** Epithets are most common, often institutionalized to the point where personal names are forgotten. The epithet becomes the identity.

### **Naming and Status**

Unlike Imperial or Ganati naming conventions, Akama names do not systematically encode social status or lineage prestige. The system values different qualities:

**Astrological names** indicate connection to traditional calendar systems and Malpais cultural roots, but don't necessarily confer higher status than epithets or Imperial names.
...
**Public names and Imperial names:** Not considered to have lexical meaning outside their function as names. Though they may derive from Akama or Imperial words historically, they are treated as proper nouns without translatable content.

**Astrological names (both family and private):** Explicitly carry lexical meaning related to the calendar phase elements (Reed, Yarrow, Bear, etc.) and are interpreted for astrological significance.

**Epithets:** Retain clear lexical meaning (Red Deer, Blackfish, Stonefoot, Iron-Rain), describing characteristics or achievements.

This creates interesting dynamics where some elements of a person's full name are semantically transparent (the epithet "Stonefoot" means exactly what it says) while others are opaque (the personal name "Imek" is simply a name).
...
### Current Junta composition represents unusual stability. One Highborn (broken and manageable), six warriors with relatively balanced power, no catastrophic conflicts imminent, and competent leadership across most positions. This stability allows members to think institutionally rather than purely defensively, to invest in infrastructure and coordinate public works, to govern for the city rather than just their individual interests. How long this stability lasts depends on factors both internal (member conflicts, succession challenges) and external (Highborn threats, major warfare, economic disruptions).
...
### Abstention is common and accepted. If member doesn't care about issue or can't determine good outcome, they simply don't vote. Not raising the token for yes is functionally no vote, but standing still without clear opposition signals indifference rather than resistance. This allows members to conserve political capital for issues they actually care about.
...
### Som's presence on the Junta represents both tremendous power and complete dysfunction. He's the reason the Tamas maintain deaf warband, the reason other members maintain careful distance, the justification for Ogon's tolerance of one Highborn. His broken state makes him manageable where functional Highborn would be existential threat. But his automatic opposition to Imperial cooperation blocks infrastructure development and diplomatic arrangements that would benefit the city.

### **Relationships**: All members maintain professional distance. Nobody wants to be close enough to risk hearing him speak if the gag fails. Tsoka blames the Empire for creating Som and exiling him rather than containing the problem. The Tamas watch him constantly, ready to act if he becomes functional threat.

### **Khan Tsoka Red Deer: The Institutionalist**
...
### **Relationships**: Likes and respects Ataru despite their feud. Finds Bal tiresome but useful. Considers Imek and Iron-Rain barbarians with potential but inadequate vision. Bitterly resents Som as Imperial failure exported to the frontier.

### **Khan Ataru Blackfish: The Commercial Emperor**
...
### **Relationships**: Likes Tsoka despite their feud, respects his capability while finding his institutional theories exhausting. Considers Bal useful but overcomplicated. Views Iron-Rain as simple but effective. Training specifically to win their next duel, recognizing it might be fatal.

### **Bal Tama: The Accommodationist**

### **Age**: 44  **Warband**: 200 deaf warriors for security  **Territory**: Central Ogon, multiple gambling halls and commercial properties  **Token Acquisition**: Gambling (probably arranged), 6 years ago
...
### **Khan Iron-Rain: The Genetic Lottery**

### **Age**: 29  **Warband**: 1,200 warriors following personal dominance  **Territory**: Northern districts, though control is informal  **Token Acquisition**: Combat, 5 years ago
...
### **Khan Imek Stone-Foot: The Lucky Survivor**
...
### **Relationships**: Close with Iron-Rain romantically and politically. Receives advice from Vey's specialists, creating alliance with Kma-Dhol technical power. Friendly with Bal, who sees her as promising tractable leader. Tsoka and Ataru consider her barbarian with potential but insufficient vision.
...
### The Junta coordinates on matters affecting multiple territories or requiring collective resources:

### **Infrastructure development**: Roads, cisterns, waste management, lighting systems that serve entire city rather than individual districts. Members contribute resources proportional to their wealth and benefit.

### **Security arrangements**: Response to external threats, coordination during major raids, management of conflicts that risk spreading beyond their immediate participants. Not systematic law enforcement but crisis management.
...
### The Junta has no enforcement mechanism beyond members' individual capabilities. Decisions are followed because members find it beneficial to follow them, because violating agreements creates enemies, because maintaining relationships serves long-term interests.

### If member violates Junta decisions, consequences are informal: other members might refuse to coordinate with them, might create economic disadvantages, might support their rivals, might eventually coordinate to remove them from power. But there's no systematic enforcement, no penalties beyond what members choose to impose through their own actions.

### This creates system where only decisions with genuine support get made and followed. Proposals requiring enforcement don't pass because members recognize they cannot be implemented. The Junta's authority extends exactly as far as members' willingness to cooperate, no further.
...
### The Tamas responded with dramatic action unprecedented in their history: spent most of their accumulated reserves (wealth of generations) to hire multiple warbands to kill three Highborn in single coordinated night operation. The assassinations were executed before any Highborn could use Compulsion to defend themselves or command vengeance. The remaining two Highborn fled or were removed shortly after.

### This crisis crystallized the Tamas' single rule: better the worst warlord than the best Highborn. It justified the deaf warband, the generational sacrifice, the war academy. It demonstrated that the Tamas will spend everything to prevent Compulsion-based rule. And it proved that even Highborn can be killed through overwhelming coordinated force if you strike before they can speak.

### **Membership Patterns**

### Reviewing the Junta's seventy-year history reveals patterns:

### **Warriors predominate**: Perhaps eighty percent of token-holders have been military leaders commanding warbands. This reflects Ogon's nature as frontier city where force ultimately determines authority.

### **Tamas often hold tokens**: The family has held tokens for approximately thirty-five of the seventy years total, though seldom for more than one generation consecutively. They take tokens during stable periods, arrange to lose them during crises.

### **Kma-Dhol representation**: Technical specialists have held one or two tokens most of the time. Vey's Seven-year tenure is typical. The Kma-Dhol's technical monopoly makes them essential enough to warrant formal representation.

### **Highborn presence**: Perhaps fifteen years total with Highborn members, counting the three-year crisis and Som's current tenure. Highborn on the Junta creates tension but can be managed if they're broken, isolated, or controllable.

### **Turnover rate**: Average tenure is perhaps five to seven years. Some hold tokens for decades, others for months. Violence, strategic exits, and power transitions create relatively rapid membership changes compared to the city's institutional continuity.
...
### Their influence operates through multiple mechanisms:

### **The honorable exit system**: If your position is untenable, if your token is burden, there's always a way out through Tama gambling halls. Bet the token on dice game, lose through bad luck rather than weakness, walk away with dignity intact. The Tamas arrange both the dice and often the winner, ensuring transfers happen smoothly.

### **The tractable proxy strategy**: Rather than holding tokens themselves, the Tamas often control other members' votes through environmental shaping, information management, and social dependencies. Iron-Rain's headquarters being Tama-owned (secretly) exemplifies this approach.

### **The dramatic action**: When existential threats emerge (five Highborn, intolerable tyrants, configurations that threaten city stability), the Tamas spend their reserves on coordinated removal. This happens rarely but decisively.

### **The stability preference**: The Tamas prefer and actively work toward stable Junta configurations. They mediate conflicts, provide neutral ground for negotiations, create contexts where consensus is possible. Stability allows them to govern openly; chaos forces them underground.

### **The Dual Role**

### Bal's current membership exemplifies the Tamas' dual role: sometimes holding tokens directly when stability permits, sometimes operating through proxies when circumstances require. He took his token six years ago when the Junta stabilized after previous conflicts. He'll probably arrange to lose it if major destabilization occurs.
...
### **Gambling**: Tokens can be wagered and lost. Sometimes genuine gambling, often arranged by Tamas to facilitate exits. The fiction of chance legitimizes transfers that serve everyone's interests.

### **Purchase**: Rarely but occasionally, tokens are bought and sold. The transaction creates clean transfer without violence.
...
### Major conflicts emerge when multiple people simultaneously claim right to token, when transfers are disputed, when violence escalates beyond normal challenge-and-resolution patterns:

### **Claimant warfare**: Multiple people believing they should hold token can trigger sustained conflict. This usually resolves quickly (one proves superior) but occasionally creates prolonged instability.

### **Proxy conflicts**: When powerful external actors back different claimants, succession becomes proxy war for larger conflicts. This is rare in Ogon but has happened.
...
### The Junta's membership occasionally reflects external power dynamics:

### **Imperial influence**: Officers with frontier connections sometimes back specific Khans, providing resources that help them acquire or maintain tokens. Tsoka's Imperial relationships affect his position this way.

### **Ganati relationships**: Trade connections to the Republic occasionally shape who prospers enough to compete for tokens, though Ganati influence is more economic than military.
...
### **What the Junta Is Not**

### The Junta is not a government in the systematic sense:

### **No laws**: No written legal code, no standardized penalties, no formal judicial process. Issues are resolved through negotiation, violence, or informal pressure.

### **No administration**: No bureaucracy implementing decisions, no systematic taxation, no documentary records of proceedings. Each member manages their own territories with their own methods.

### **No monopoly on violence**: Members maintain independent military forces. The Junta coordinates their violence but doesn't control it monopolistically.

### **No succession mechanism**: No formal process for how tokens transfer, no constitutional procedures, no appeal systems. Power transitions happen through force, negotiation, or circumstance.

### **No sovereignty claim**: The Junta doesn't claim to rule Ogon in the sense of having legal authority over all residents. It coordinates between powers that could destroy each other, creating stability through mutual recognition rather than imposed order.

### **What the Junta Is**

### Instead, the Junta functions as:

### **Coordination mechanism**: Creates space for negotiation between military powers, allowing infrastructure development and resource management that benefits everyone.

### **Neutral ground provider**: Through the Slab gatherings and associated institutions, creates contexts where even enemies can negotiate safely.
...
### **Power stabilizer**: Through its mere existence, reduces incentives for catastrophic warfare by creating institutional framework where even temporary cooperation benefits all parties.

### **The Governance Gap**

### Ogon functions through layers of authority that don't map to systematic governance:

### **District control**: Each Junta member controls specific territories where their word is law, enforced by their forces. These are essentially independent jurisdictions that happen to coordinate.

### **Service provision**: The Tamas, the Kma-Dhol, various commercial operators provide essential services (gambling, technical expertise, trade) independent of formal authority.

### **Community structures**: Neighborhoods, kinship networks, economic associations create order at local level through mechanisms the Junta doesn't touch.

### **Power vacuums**: Areas where no member maintains control function through informal arrangements, local strongmen, or simple chaos.

### The Junta coordinates at the top without governing the middle or bottom. This creates functional city despite lacking systematic administration. Services get provided through market mechanisms and voluntary coordination rather than bureaucratic implementation. Order emerges from multiple overlapping systems rather than imposed hierarchy.

### This works because everyone understands the actual power relationships and doesn't depend on fictional legal authority. The Junta's decisions matter because members have capability to implement them through their own forces and resources, not because some abstract legal system enforces them.
...
### **Highborn risk**: Som is manageable, but if functional Highborn arrived or if Som somehow became functional, the entire system faces existential threat. The Tamas remain vigilant for this possibility.

### **External warfare**: Major conflict in the Thousand Kingdoms or Imperial military operations could push powerful forces toward Ogon, creating challenges to current members or pressure for Junta expansion beyond seven members.
...
### Several elements promote continued stability:

### **Institutional thinking**: Tsoka, Ataru, and Vey all think beyond immediate survival, building structures that might outlast current leadership. This creates continuity even as specific members change.

### **Tama management**: The family's four-hundred-year survival strategy includes actively maintaining Junta stability. They have strong incentives to prevent catastrophic conflicts and manage power transitions smoothly.

### **Economic interdependence**: Members benefit from the city's prosperity. Destroying that prosperity through warfare hurts everyone. This creates incentives for cooperation even among rivals.

### **External pressures**: Both the Empire and various Thousand Kingdoms powers have stakes in Ogon's stability. They might intervene to prevent total collapse, creating external support for continued coordination.

### **The token system itself**: By embodying authority in physical objects that can transfer through multiple mechanisms, the system allows leadership changes without destroying institutional continuity. The Junta persists regardless of who holds the tokens.

### **Successful precedent**: Seventy years of generally functional coordination demonstrates that the system works. Members have seen alternatives (chaos, warfare, Highborn domination) and recognize current arrangements serve their interests better than likely alternatives.
...
### The seven tokens sit on the Slab each month. The members vote with raised or lowered hands. And somehow, despite everything, the city functions.

### Your Junta of Ogon governance report is ready. It details the seven irreplaceable power tokens, the Slab parliament system, monthly voting procedures enforced by trial-by-combat, the brutal Accession Ritual requiring aspirants to endure beatings until sunrise, and the mechanics of this warlord oligarchy that prevents any single Khan from dominating coastal Oregon's Thousand Kingdoms.
...
Warbands range from disciplined formations matching Imperial regulars to barely-controlled mobs. The strongest, like those controlling Ogon, function as proto-states with permanent infrastructure. The weakest are bandits with pretensions.
...
Between ya-Sattra and Ogon stretches five hundred kilometers where Imperial sovereignty transitions from bureaucratic reality to convenient fiction. Colonel-Hereditary estates and Akama warbands maintain elaborate performances: tribute ceremonies that are actually diplomatic negotiations, tax collection resembling protection money, military subordination masking strategic partnerships.

Imperial control doesn't end at a border but dissolves gradually. North of ya-Tsatsa, institutions begin erosion. By two hundred kilometers north, fiction becomes visible. By three hundred kilometers, Imperial authority exists primarily as performance.
...
The Malpais represents Akama culture without compromise. Scattered villages survive through calibrated submission to mounted warbands who extract tribute without destroying productive capacity.
...
Forty thousand sewer-fishers live throughout the Ogon complex as recognized technical specialists. Unlike their hidden cousins in ya-Sattra's Middens, the Kma-Dhol operate openly under theological framework treating them as possessing "clever souls" judged by different ancestral standards.
...
The fundamental difference between Imperial and Akama society lies in how each handles inequality. The Empire recognizes that engineered hierarchy creates injustice requiring mitigation. The Akama have no such project. They view genetic inequality as natural and just, requiring no mitigation. Where the Empire tries to separate legal authority from personal power, the Akama embrace their identity.

## **Examples of Akama Arts**
...
Worthy threw me at the river crossing. I went in face-first and came up with a fish in my shirt. The fish was more surprised than I was. I got back on.

Worthy threw me in front of Toghan Six Crow's daughter, the one with the good teeth. I landed in goat dung. She married someone else. I got back on.

Worthy threw me seventeen times that summer. I kept count. On the eighteenth time, I stayed on. He was too tired to throw me again.

Worthy died of old age last spring. I buried him where he threw me the first time. I visit sometimes, to check if he's staying down.
...
*Sung by Orvak Three-Fingers before the raid on Keth-Masol, as recorded by witnesses*

I held the canal-gate at Broken Glass for two days when the Torek came. They sent nine riders the first morning. Three came back. They sent fourteen the second day. None came back. On the third day they went around.

I killed Dhom Ironfoot in single combat at the Gathering of Knives. He was taller than me by a head. He had two more fingers than I do. He doesn't have anything now.

My grandfather held the eastern scarp against the Republic's scouts. My father held it after him. I hold it now. When my sons are grown, they will hold it, or they will not be my sons.

I am Orvak Three-Fingers of the Cracked Shield Band. I have told you what I have done. Tomorrow we ride to Keth-Masol. You will see what I will do.

---

### **A Genealogy**

*Recited by Vurda Eleven-Sage at her daughter's naming ceremony*

My mother was Khoram Eleven-Sage, who kept the herds through the Bitter Winter when half the calves died and the other half lived because she knew which ones to bring inside. Her mother was Tsogha Eleven-Sage, who married into the line from Seven Elk and brought the fishing rights at the third bend. Her mother was Gholdara Seven Elk, who was beautiful and cruel and outlived four husbands, each one richer than the last.

Before Gholdara the records are unclear. We say the line runs back to the Fourth Oracle through a daughter whose name is forgotten, but many say this, and who can prove it now? What we can prove is the fishing rights. What we can prove is the herds. What we can prove is that Eleven-Sage women survive, and what survives is what matters.

My daughter is Makhru Eleven-Sage. She was born on an unlucky day, so we waited, and named her when the sage-phase came around again. She will learn the herds. She will learn which calves to save. She will learn that survival is the only proof of worth.

This is her inheritance. May she use it well or lose it trying.

---

### **Abstract Work: A Garden in Ogon**
...
### **Monumental Carving: The Masks at Dharel's Span**
...
The band that holds Dharel's Span now claims descent from both the riders and the defenders. They say the scene shows an alliance being formed, not a battle. The Torek, who held the span before them, said it showed their ancestors' victory over invaders. The carving supports both readings. It will support others, when the span changes hands again.

---

### **A Song for the Quiet Times**

*Sometimes sung in villages during the long evenings, attributed to no one in particular*

The barley is in. The rain will come or it won't. The destriers are pastured and the calves are counted. There is nothing to do tonight but sit.

My hands are rough from the work I've done. My back aches from the loads I've carried. Tomorrow there will be more. Tonight there is only the fire.

The raiders will come in spring or they won't. The tribute will be what it always is. Someone else can worry about the fords. Tonight I am warm and my bowl is full.

The great men do great things. The strong men do strong things. I mended the fence where the goat broke through. It was not a great thing, but the goat is inside now.

---

### **An Arrow-Maker's Observation**

*Attributed to Tsur Dust-Eater, who made arrows for the Broken Ridge band for forty years*

People think the wood is the shaft and the feathers make it fly. They have it backwards. The wood is what you remove to find the shaft. The feathers are what you add to show the shaft where to go.
